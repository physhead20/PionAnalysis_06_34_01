...
// Thu Aug 24 08:15:58 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/DDMC_RunIINegHYElecton_anatree.root
//////////////////////////////////////////////////////////

#ifndef ElectronDDMC_RunIIHY_h
#define ElectronDDMC_RunIIHY_h
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[92];   //[nclus]
   Double_t        clusterttick[92];   //[nclus]
   Double_t        cluendwire[92];   //[nclus]
   Double_t        cluendtick[92];   //[nclus]
   Int_t           cluplane[92];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           trkWCtoTPCMatch[29];   //[ntracks_reco]
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1503];   //[nhits]
   Int_t           hit_wire[1503];   //[nhits]
   Int_t           hit_channel[1503];   //[nhits]
   Double_t        hit_peakT[1503];   //[nhits]
   Double_t        hit_charge[1503];   //[nhits]
   Double_t        hit_ph[1503];   //[nhits]
   Double_t        hit_tstart[1503];   //[nhits]
   Double_t        hit_tend[1503];   //[nhits]
   Int_t           hit_trkid[1503];   //[nhits]
   Int_t           hit_trkkey[1503];   //[nhits]
   Int_t           hit_clukey[1503];   //[nhits]
   Int_t           hit_pk[1503];   //[nhits]
   Int_t           hit_t[1503];   //[nhits]
   Int_t           hit_ch[1503];   //[nhits]
   Int_t           hit_fwhh[1503];   //[nhits]
   Double_t        hit_rms[1503];   //[nhits]
   Double_t        hit_nelec[1503];   //[nhits]
   Double_t        hit_energy[1503];   //[nhits]
   Float_t         hit_dQds[1503];   //[nhits]
   Float_t         hit_dEds[1503];   //[nhits]
   Float_t         hit_ds[1503];   //[nhits]
   Float_t         hit_resrange[1503];   //[nhits]
   Float_t         hit_x[1503];   //[nhits]
   Float_t         hit_y[1503];   //[nhits]
   Float_t         hit_z[1503];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2449];   //[maxTrackIDE]
   Double_t        IDEPos[2449][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[160];   //[geant_list_size]
   Double_t        Eng[160];   //[geant_list_size]
   Double_t        Px[160];   //[geant_list_size]
   Double_t        Py[160];   //[geant_list_size]
   Double_t        Pz[160];   //[geant_list_size]
   Double_t        EndEng[160];   //[geant_list_size]
   Double_t        EndPx[160];   //[geant_list_size]
   Double_t        EndPy[160];   //[geant_list_size]
   Double_t        EndPz[160];   //[geant_list_size]
   Double_t        StartPointx[160];   //[geant_list_size]
   Double_t        StartPointy[160];   //[geant_list_size]
   Double_t        StartPointz[160];   //[geant_list_size]
   Double_t        EndPointx[160];   //[geant_list_size]
   Double_t        EndPointy[160];   //[geant_list_size]
   Double_t        EndPointz[160];   //[geant_list_size]
   Int_t           Process[160];   //[geant_list_size]
   Int_t           NumberDaughters[160];   //[geant_list_size]
   Int_t           Mother[160];   //[geant_list_size]
   Int_t           TrackId[160];   //[geant_list_size]
   Int_t           process_primary[160];   //[geant_list_size]
   ...
   ElectronDDMC_RunIIHY(TTree *tree=0);
   virtual ~ElectronDDMC_RunIIHY();
...
#ifdef ElectronDDMC_RunIIHY_cxx
ElectronDDMC_RunIIHY::ElectronDDMC_RunIIHY(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/DDMC_RunIINegHYElecton_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/DDMC_RunIINegHYElecton_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/DDMC_RunIINegHYElecton_anatree.root:/anatree");
...
ElectronDDMC_RunIIHY::~ElectronDDMC_RunIIHY()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ElectronDDMC_RunIIHY::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ElectronDDMC_RunIIHY::LoadTree(Long64_t entry)
{
...
void ElectronDDMC_RunIIHY::Init(TTree *tree)
{
...
Bool_t ElectronDDMC_RunIIHY::Notify()
{
...
void ElectronDDMC_RunIIHY::Show(Long64_t entry)
{
...
Int_t ElectronDDMC_RunIIHY::Cut(Long64_t entry)
{
...
#endif // #ifdef ElectronDDMC_RunIIHY_cxx

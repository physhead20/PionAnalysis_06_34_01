#define ElectronDDMC_RunIIHY_cxx
#include "ElectronDDMC_RunIIHY.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void ElectronDDMC_RunIIHY::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../histoROOTfiles_forPlots/DDMC_Electron_RunIIHY_histo.root","RECREATE");

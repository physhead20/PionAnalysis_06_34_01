...
public :
   ...
   HYTrk_RunINeg_PiMuE(TTree *tree=0);
   virtual ~HYTrk_RunINeg_PiMuE();
...
#ifdef HYTrk_RunINeg_PiMuE_cxx
HYTrk_RunINeg_PiMuE::HYTrk_RunINeg_PiMuE(TTree *tree) : fChain(0) 
{
...
HYTrk_RunINeg_PiMuE::~HYTrk_RunINeg_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HYTrk_RunINeg_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HYTrk_RunINeg_PiMuE::LoadTree(Long64_t entry)
{
...
void HYTrk_RunINeg_PiMuE::Init(TTree *tree)
{
...
Bool_t HYTrk_RunINeg_PiMuE::Notify()
{
...
void HYTrk_RunINeg_PiMuE::Show(Long64_t entry)
{
...
Int_t HYTrk_RunINeg_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef HYTrk_RunINeg_PiMuE_cxx

...
public :
   ...
   PickyTrk_RunIPos_PiMuE(TTree *tree=0);
   virtual ~PickyTrk_RunIPos_PiMuE();
...
#ifdef PickyTrk_RunIPos_PiMuE_cxx
PickyTrk_RunIPos_PiMuE::PickyTrk_RunIPos_PiMuE(TTree *tree) : fChain(0) 
{
...
PickyTrk_RunIPos_PiMuE::~PickyTrk_RunIPos_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIPos_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIPos_PiMuE::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIPos_PiMuE::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIPos_PiMuE::Notify()
{
...
void PickyTrk_RunIPos_PiMuE::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIPos_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIPos_PiMuE_cxx

#define HYTrk_RunINeg_PiMuE_cxx
#include "HYTrk_RunINeg_PiMuE.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
TFile myfile("../histoROOTfiles_forPlots/dEdXCalib_RunINeg_HY_PiMuE.root","RECREATE");

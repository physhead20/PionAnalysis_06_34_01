...
public :
   ...
   PickyTrk_RunINeg_PiMuE(TTree *tree=0);
   virtual ~PickyTrk_RunINeg_PiMuE();
...
#ifdef PickyTrk_RunINeg_PiMuE_cxx
PickyTrk_RunINeg_PiMuE::PickyTrk_RunINeg_PiMuE(TTree *tree) : fChain(0) 
{
...
PickyTrk_RunINeg_PiMuE::~PickyTrk_RunINeg_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunINeg_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunINeg_PiMuE::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunINeg_PiMuE::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunINeg_PiMuE::Notify()
{
...
void PickyTrk_RunINeg_PiMuE::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunINeg_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunINeg_PiMuE_cxx

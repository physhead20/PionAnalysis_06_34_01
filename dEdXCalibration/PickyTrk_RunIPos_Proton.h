...
public :
   ...
   PickyTrk_RunIPos_Proton(TTree *tree=0);
   virtual ~PickyTrk_RunIPos_Proton();
...
#ifdef PickyTrk_RunIPos_Proton_cxx
PickyTrk_RunIPos_Proton::PickyTrk_RunIPos_Proton(TTree *tree) : fChain(0) 
{
...
PickyTrk_RunIPos_Proton::~PickyTrk_RunIPos_Proton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIPos_Proton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIPos_Proton::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIPos_Proton::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIPos_Proton::Notify()
{
...
void PickyTrk_RunIPos_Proton::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIPos_Proton::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIPos_Proton_cxx

...
// Thu Jun 15 13:05:45 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PickyTrack_RunII_Proton_PosPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIIPos_Proton_h
#define PickyTrk_RunIIPos_Proton_h
...
class PickyTrk_RunIIPos_Proton {
public :
   ...
   PickyTrk_RunIIPos_Proton(TTree *tree=0);
   virtual ~PickyTrk_RunIIPos_Proton();
...
#ifdef PickyTrk_RunIIPos_Proton_cxx
PickyTrk_RunIIPos_Proton::PickyTrk_RunIIPos_Proton(TTree *tree) : fChain(0) 
{
...
PickyTrk_RunIIPos_Proton::~PickyTrk_RunIIPos_Proton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIIPos_Proton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIIPos_Proton::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIIPos_Proton::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIIPos_Proton::Notify()
{
...
void PickyTrk_RunIIPos_Proton::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIIPos_Proton::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIIPos_Proton_cxx

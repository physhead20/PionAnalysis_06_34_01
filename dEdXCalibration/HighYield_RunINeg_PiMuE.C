#define HighYield_RunINeg_PiMuE_cxx
#include "HighYield_RunINeg_PiMuE.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void HighYield_RunINeg_PiMuE::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../histoROOTfiles_forPlots/dEdXCalib_RunINeg_HighYield_PiMuE_Induction.root","RECREATE");

...
// Wed Jun 14 10:06:25 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/HighYield_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef HighYield_RunINeg_PiMuE_h
#define HighYield_RunINeg_PiMuE_h
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[537];   //[nclus]
   Double_t        clusterttick[537];   //[nclus]
   Double_t        cluendwire[537];   //[nclus]
   Double_t        cluendtick[537];   //[nclus]
   Int_t           cluplane[537];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[122];   //[ntracks_reco]
   Double_t        trkvtxy[122];   //[ntracks_reco]
   Double_t        trkvtxz[122];   //[ntracks_reco]
   Double_t        trkendx[122];   //[ntracks_reco]
   Double_t        trkendy[122];   //[ntracks_reco]
   Double_t        trkendz[122];   //[ntracks_reco]
   Double_t        trkstartdcosx[122];   //[ntracks_reco]
   Double_t        trkstartdcosy[122];   //[ntracks_reco]
   Double_t        trkstartdcosz[122];   //[ntracks_reco]
   Double_t        trkenddcosx[122];   //[ntracks_reco]
   Double_t        trkenddcosy[122];   //[ntracks_reco]
   Double_t        trkenddcosz[122];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[122];   //[ntracks_reco]
   Double_t        trklength[122];   //[ntracks_reco]
   Double_t        trkmomrange[122];   //[ntracks_reco]
   Double_t        trkmommschi2[122];   //[ntracks_reco]
   Double_t        trkmommsllhd[122];   //[ntracks_reco]
   Int_t           ntrkhits[122];   //[ntracks_reco]
   Double_t        trkx[122][1000];   //[ntracks_reco]
   Double_t        trky[122][1000];   //[ntracks_reco]
   Double_t        trkz[122][1000];   //[ntracks_reco]
   Double_t        trkpitch[122][2];   //[ntracks_reco]
   Int_t           trkhits[122][2];   //[ntracks_reco]
   Double_t        trkdedx[122][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[122][2][1000];   //[ntracks_reco]
   Double_t        trkrr[122][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[122][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[122][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[122][2];   //[ntracks_reco]
   Double_t        trkpida[122][2];   //[ntracks_reco]
   Int_t           nTrajPoint[122];   //[ntracks_reco]
   Double_t        pHat0_X[122][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[122][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[122][1000];   //[ntracks_reco]
   Double_t        trjPt_X[122][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[122][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[122][1000];   //[ntracks_reco]
   Int_t           trkg4id[122];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[17048];   //[nhits]
   Int_t           hit_wire[17048];   //[nhits]
   Int_t           hit_channel[17048];   //[nhits]
   Double_t        hit_peakT[17048];   //[nhits]
   Double_t        hit_charge[17048];   //[nhits]
   Double_t        hit_ph[17048];   //[nhits]
   Double_t        hit_tstart[17048];   //[nhits]
   Double_t        hit_tend[17048];   //[nhits]
   Int_t           hit_trkid[17048];   //[nhits]
   Int_t           hit_trkkey[17048];   //[nhits]
   Int_t           hit_clukey[17048];   //[nhits]
   Int_t           hit_pk[17048];   //[nhits]
   Int_t           hit_t[17048];   //[nhits]
   Int_t           hit_ch[17048];   //[nhits]
   Int_t           hit_fwhh[17048];   //[nhits]
   Double_t        hit_rms[17048];   //[nhits]
   Double_t        hit_nelec[17048];   //[nhits]
   Double_t        hit_energy[17048];   //[nhits]
   Float_t         hit_dQds[17048];   //[nhits]
   Float_t         hit_dEds[17048];   //[nhits]
   Float_t         hit_ds[17048];   //[nhits]
   Float_t         hit_resrange[17048];   //[nhits]
   Float_t         hit_x[17048];   //[nhits]
   Float_t         hit_y[17048];   //[nhits]
   Float_t         hit_z[17048];   //[nhits]
   Int_t           nwctrks;
   ...
   HighYield_RunINeg_PiMuE(TTree *tree=0);
   virtual ~HighYield_RunINeg_PiMuE();
...
#ifdef HighYield_RunINeg_PiMuE_cxx
HighYield_RunINeg_PiMuE::HighYield_RunINeg_PiMuE(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/HighYield_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/HighYield_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/HighYield_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree.root:/anatree");
...
HighYield_RunINeg_PiMuE::~HighYield_RunINeg_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HighYield_RunINeg_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HighYield_RunINeg_PiMuE::LoadTree(Long64_t entry)
{
...
void HighYield_RunINeg_PiMuE::Init(TTree *tree)
{
...
Bool_t HighYield_RunINeg_PiMuE::Notify()
{
...
void HighYield_RunINeg_PiMuE::Show(Long64_t entry)
{
...
Int_t HighYield_RunINeg_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef HighYield_RunINeg_PiMuE_cxx

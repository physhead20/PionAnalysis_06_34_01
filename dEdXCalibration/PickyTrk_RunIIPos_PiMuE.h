...
public :
   ...
   PickyTrk_RunIIPos_PiMuE(TTree *tree=0);
   virtual ~PickyTrk_RunIIPos_PiMuE();
...
#ifdef PickyTrk_RunIIPos_PiMuE_cxx
PickyTrk_RunIIPos_PiMuE::PickyTrk_RunIIPos_PiMuE(TTree *tree) : fChain(0) 
{
...
PickyTrk_RunIIPos_PiMuE::~PickyTrk_RunIIPos_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIIPos_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIIPos_PiMuE::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIIPos_PiMuE::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIIPos_PiMuE::Notify()
{
...
void PickyTrk_RunIIPos_PiMuE::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIIPos_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIIPos_PiMuE_cxx

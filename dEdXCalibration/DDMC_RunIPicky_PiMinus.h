...
// Tue Jun 13 18:10:43 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/DDMC_RunI_PickyTrkNegPol_PiMinus_anatree.root
//////////////////////////////////////////////////////////

#ifndef DDMC_RunIPicky_PiMinus_h
#define DDMC_RunIPicky_PiMinus_h
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[56];   //[nclus]
   Double_t        clusterttick[56];   //[nclus]
   Double_t        cluendwire[56];   //[nclus]
   Double_t        cluendtick[56];   //[nclus]
   Int_t           cluplane[56];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[20];   //[ntracks_reco]
   Double_t        trkvtxy[20];   //[ntracks_reco]
   Double_t        trkvtxz[20];   //[ntracks_reco]
   Double_t        trkendx[20];   //[ntracks_reco]
   Double_t        trkendy[20];   //[ntracks_reco]
   Double_t        trkendz[20];   //[ntracks_reco]
   Double_t        trkstartdcosx[20];   //[ntracks_reco]
   Double_t        trkstartdcosy[20];   //[ntracks_reco]
   Double_t        trkstartdcosz[20];   //[ntracks_reco]
   Double_t        trkenddcosx[20];   //[ntracks_reco]
   Double_t        trkenddcosy[20];   //[ntracks_reco]
   Double_t        trkenddcosz[20];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[20];   //[ntracks_reco]
   Double_t        trklength[20];   //[ntracks_reco]
   Double_t        trkmomrange[20];   //[ntracks_reco]
   Double_t        trkmommschi2[20];   //[ntracks_reco]
   Double_t        trkmommsllhd[20];   //[ntracks_reco]
   Int_t           ntrkhits[20];   //[ntracks_reco]
   Double_t        trkx[20][1000];   //[ntracks_reco]
   Double_t        trky[20][1000];   //[ntracks_reco]
   Double_t        trkz[20][1000];   //[ntracks_reco]
   Double_t        trkpitch[20][2];   //[ntracks_reco]
   Int_t           trkhits[20][2];   //[ntracks_reco]
   Double_t        trkdedx[20][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[20][2][1000];   //[ntracks_reco]
   Double_t        trkrr[20][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[20][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[20][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[20][2];   //[ntracks_reco]
   Double_t        trkpida[20][2];   //[ntracks_reco]
   Int_t           nTrajPoint[20];   //[ntracks_reco]
   Double_t        pHat0_X[20][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[20][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[20][1000];   //[ntracks_reco]
   Double_t        trjPt_X[20][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[20][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[20][1000];   //[ntracks_reco]
   Int_t           trkg4id[20];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[869];   //[nhits]
   Int_t           hit_wire[869];   //[nhits]
   Int_t           hit_channel[869];   //[nhits]
   Double_t        hit_peakT[869];   //[nhits]
   Double_t        hit_charge[869];   //[nhits]
   Double_t        hit_ph[869];   //[nhits]
   Double_t        hit_tstart[869];   //[nhits]
   Double_t        hit_tend[869];   //[nhits]
   Int_t           hit_trkid[869];   //[nhits]
   Int_t           hit_trkkey[869];   //[nhits]
   Int_t           hit_clukey[869];   //[nhits]
   Int_t           hit_pk[869];   //[nhits]
   Int_t           hit_t[869];   //[nhits]
   Int_t           hit_ch[869];   //[nhits]
   Int_t           hit_fwhh[869];   //[nhits]
   Double_t        hit_rms[869];   //[nhits]
   Double_t        hit_nelec[869];   //[nhits]
   Double_t        hit_energy[869];   //[nhits]
   Float_t         hit_dQds[869];   //[nhits]
   Float_t         hit_dEds[869];   //[nhits]
   Float_t         hit_ds[869];   //[nhits]
   Float_t         hit_resrange[869];   //[nhits]
   Float_t         hit_x[869];   //[nhits]
   Float_t         hit_y[869];   //[nhits]
   Float_t         hit_z[869];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[4074];   //[maxTrackIDE]
   Double_t        IDEPos[4074][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[274];   //[geant_list_size]
   Double_t        Eng[274];   //[geant_list_size]
   Double_t        Px[274];   //[geant_list_size]
   Double_t        Py[274];   //[geant_list_size]
   Double_t        Pz[274];   //[geant_list_size]
   Double_t        EndEng[274];   //[geant_list_size]
   Double_t        EndPx[274];   //[geant_list_size]
   Double_t        EndPy[274];   //[geant_list_size]
   Double_t        EndPz[274];   //[geant_list_size]
   Double_t        StartPointx[274];   //[geant_list_size]
   Double_t        StartPointy[274];   //[geant_list_size]
   Double_t        StartPointz[274];   //[geant_list_size]
   Double_t        EndPointx[274];   //[geant_list_size]
   Double_t        EndPointy[274];   //[geant_list_size]
   Double_t        EndPointz[274];   //[geant_list_size]
   Int_t           Process[274];   //[geant_list_size]
   Int_t           NumberDaughters[274];   //[geant_list_size]
   Int_t           Mother[274];   //[geant_list_size]
   Int_t           TrackId[274];   //[geant_list_size]
   Int_t           process_primary[274];   //[geant_list_size]
   ...
   DDMC_RunIPicky_PiMinus(TTree *tree=0);
   virtual ~DDMC_RunIPicky_PiMinus();
...
#ifdef DDMC_RunIPicky_PiMinus_cxx
DDMC_RunIPicky_PiMinus::DDMC_RunIPicky_PiMinus(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/DDMC_RunI_PickyTrkNegPol_PiMinus_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/DDMC_RunI_PickyTrkNegPol_PiMinus_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/DDMC_RunI_PickyTrkNegPol_PiMinus_anatree.root:/anatree");
...
DDMC_RunIPicky_PiMinus::~DDMC_RunIPicky_PiMinus()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DDMC_RunIPicky_PiMinus::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DDMC_RunIPicky_PiMinus::LoadTree(Long64_t entry)
{
...
void DDMC_RunIPicky_PiMinus::Init(TTree *tree)
{
...
Bool_t DDMC_RunIPicky_PiMinus::Notify()
{
...
void DDMC_RunIPicky_PiMinus::Show(Long64_t entry)
{
...
Int_t DDMC_RunIPicky_PiMinus::Cut(Long64_t entry)
{
...
#endif // #ifdef DDMC_RunIPicky_PiMinus_cxx

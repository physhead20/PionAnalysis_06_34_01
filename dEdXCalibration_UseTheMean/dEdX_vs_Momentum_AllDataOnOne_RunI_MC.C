...
dEdX[3]       = hProton300_350->GetMean(1);
dEdXError[3]  = hProton300_350->GetMeanError(1);
...
dEdX[4]       = hProton350_400->GetMean(1);
dEdXError[4]  = hProton350_400->GetMeanError(1);
...
dEdX[5]       = hProton400_450->GetMean(1);
dEdXError[5]  = hProton400_450->GetMeanError(1);
...
// !!!! This bin has too little data for consideration !!!!
dEdX[7]       = hProton500_550->GetMean(1);
dEdXError[7]  = hProton500_550->GetMeanError(1);
...
grprotondata->SetLineColor(kAzure-8);
...
leg->SetHeader("LArIAT Run-I Monte Carlo");
leg->AddEntry(grPionData,"#pi^{-} MC");
leg->AddEntry(grprotondata,"Proton MC");

#define PickyTrk_PiMuE_NegPol_cxx
#include "PickyTrk_PiMuE_NegPol.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PickyTrk_PiMuE_NegPol::Loop()
{
...
TFile myfile("../histoROOTfiles_forPlots/RunINeg_Picky_PiMuE_dataHisto.root","RECREATE");

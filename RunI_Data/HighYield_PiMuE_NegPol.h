...
public :
   ...
   HighYield_PiMuE_NegPol(TTree *tree=0);
   virtual ~HighYield_PiMuE_NegPol();
...
#ifdef HighYield_PiMuE_NegPol_cxx
HighYield_PiMuE_NegPol::HighYield_PiMuE_NegPol(TTree *tree) : fChain(0) 
{
...
HighYield_PiMuE_NegPol::~HighYield_PiMuE_NegPol()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HighYield_PiMuE_NegPol::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HighYield_PiMuE_NegPol::LoadTree(Long64_t entry)
{
...
void HighYield_PiMuE_NegPol::Init(TTree *tree)
{
...
Bool_t HighYield_PiMuE_NegPol::Notify()
{
...
void HighYield_PiMuE_NegPol::Show(Long64_t entry)
{
...
Int_t HighYield_PiMuE_NegPol::Cut(Long64_t entry)
{
...
#endif // #ifdef HighYield_PiMuE_NegPol_cxx

...
public :
   ...
   PickyTrk_PiMuE_NegPol(TTree *tree=0);
   virtual ~PickyTrk_PiMuE_NegPol();
...
#ifdef PickyTrk_PiMuE_NegPol_cxx
PickyTrk_PiMuE_NegPol::PickyTrk_PiMuE_NegPol(TTree *tree) : fChain(0) 
{
...
PickyTrk_PiMuE_NegPol::~PickyTrk_PiMuE_NegPol()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_PiMuE_NegPol::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_PiMuE_NegPol::LoadTree(Long64_t entry)
{
...
void PickyTrk_PiMuE_NegPol::Init(TTree *tree)
{
...
Bool_t PickyTrk_PiMuE_NegPol::Notify()
{
...
void PickyTrk_PiMuE_NegPol::Show(Long64_t entry)
{
...
Int_t PickyTrk_PiMuE_NegPol::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_PiMuE_NegPol_cxx

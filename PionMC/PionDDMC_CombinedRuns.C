#define PionDDMC_CombinedRuns_cxx
#include "PionDDMC_CombinedRuns.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PionDDMC_CombinedRuns::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../histoROOTfiles_forPlots/DDMC_Pion_CombinedRuns_histo.root","RECREATE");

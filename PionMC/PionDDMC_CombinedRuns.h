...
// Thu Aug 24 07:56:17 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/DDMC_CombinedRuns_Pion_anatree.root
//////////////////////////////////////////////////////////

#ifndef PionDDMC_CombinedRuns_h
#define PionDDMC_CombinedRuns_h
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[74];   //[nclus]
   Double_t        clusterttick[74];   //[nclus]
   Double_t        cluendwire[74];   //[nclus]
   Double_t        cluendtick[74];   //[nclus]
   Int_t           cluplane[74];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[19];   //[ntracks_reco]
   Double_t        trkvtxy[19];   //[ntracks_reco]
   Double_t        trkvtxz[19];   //[ntracks_reco]
   Double_t        trkendx[19];   //[ntracks_reco]
   Double_t        trkendy[19];   //[ntracks_reco]
   Double_t        trkendz[19];   //[ntracks_reco]
   Double_t        trkstartdcosx[19];   //[ntracks_reco]
   Double_t        trkstartdcosy[19];   //[ntracks_reco]
   Double_t        trkstartdcosz[19];   //[ntracks_reco]
   Double_t        trkenddcosx[19];   //[ntracks_reco]
   Double_t        trkenddcosy[19];   //[ntracks_reco]
   Double_t        trkenddcosz[19];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[19];   //[ntracks_reco]
   Double_t        trklength[19];   //[ntracks_reco]
   Double_t        trkmomrange[19];   //[ntracks_reco]
   Double_t        trkmommschi2[19];   //[ntracks_reco]
   Double_t        trkmommsllhd[19];   //[ntracks_reco]
   Int_t           ntrkhits[19];   //[ntracks_reco]
   Double_t        trkx[19][1000];   //[ntracks_reco]
   Double_t        trky[19][1000];   //[ntracks_reco]
   Double_t        trkz[19][1000];   //[ntracks_reco]
   Double_t        trkpitch[19][2];   //[ntracks_reco]
   Int_t           trkhits[19][2];   //[ntracks_reco]
   Double_t        trkdedx[19][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[19][2][1000];   //[ntracks_reco]
   Double_t        trkrr[19][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[19][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[19][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[19][2];   //[ntracks_reco]
   Double_t        trkpida[19][2];   //[ntracks_reco]
   Int_t           nTrajPoint[19];   //[ntracks_reco]
   Double_t        pHat0_X[19][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[19][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[19][1000];   //[ntracks_reco]
   Double_t        trjPt_X[19][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[19][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[19][1000];   //[ntracks_reco]
   Int_t           trkg4id[19];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1019];   //[nhits]
   Int_t           hit_wire[1019];   //[nhits]
   Int_t           hit_channel[1019];   //[nhits]
   Double_t        hit_peakT[1019];   //[nhits]
   Double_t        hit_charge[1019];   //[nhits]
   Double_t        hit_ph[1019];   //[nhits]
   Double_t        hit_tstart[1019];   //[nhits]
   Double_t        hit_tend[1019];   //[nhits]
   Int_t           hit_trkid[1019];   //[nhits]
   Int_t           hit_trkkey[1019];   //[nhits]
   Int_t           hit_clukey[1019];   //[nhits]
   Int_t           hit_pk[1019];   //[nhits]
   Int_t           hit_t[1019];   //[nhits]
   Int_t           hit_ch[1019];   //[nhits]
   Int_t           hit_fwhh[1019];   //[nhits]
   Double_t        hit_rms[1019];   //[nhits]
   Double_t        hit_nelec[1019];   //[nhits]
   Double_t        hit_energy[1019];   //[nhits]
   Float_t         hit_dQds[1019];   //[nhits]
   Float_t         hit_dEds[1019];   //[nhits]
   Float_t         hit_ds[1019];   //[nhits]
   Float_t         hit_resrange[1019];   //[nhits]
   Float_t         hit_x[1019];   //[nhits]
   Float_t         hit_y[1019];   //[nhits]
   Float_t         hit_z[1019];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[4941];   //[maxTrackIDE]
   Double_t        IDEPos[4941][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[309];   //[geant_list_size]
   Double_t        Eng[309];   //[geant_list_size]
   Double_t        Px[309];   //[geant_list_size]
   Double_t        Py[309];   //[geant_list_size]
   Double_t        Pz[309];   //[geant_list_size]
   Double_t        EndEng[309];   //[geant_list_size]
   Double_t        EndPx[309];   //[geant_list_size]
   Double_t        EndPy[309];   //[geant_list_size]
   Double_t        EndPz[309];   //[geant_list_size]
   Double_t        StartPointx[309];   //[geant_list_size]
   Double_t        StartPointy[309];   //[geant_list_size]
   Double_t        StartPointz[309];   //[geant_list_size]
   Double_t        EndPointx[309];   //[geant_list_size]
   Double_t        EndPointy[309];   //[geant_list_size]
   Double_t        EndPointz[309];   //[geant_list_size]
   Int_t           Process[309];   //[geant_list_size]
   Int_t           NumberDaughters[309];   //[geant_list_size]
   Int_t           Mother[309];   //[geant_list_size]
   Int_t           TrackId[309];   //[geant_list_size]
   Int_t           process_primary[309];   //[geant_list_size]
   ...
   PionDDMC_CombinedRuns(TTree *tree=0);
   virtual ~PionDDMC_CombinedRuns();
...
#ifdef PionDDMC_CombinedRuns_cxx
PionDDMC_CombinedRuns::PionDDMC_CombinedRuns(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/DDMC_CombinedRuns_Pion_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/DDMC_CombinedRuns_Pion_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/DDMC_CombinedRuns_Pion_anatree.root:/anatree");
...
PionDDMC_CombinedRuns::~PionDDMC_CombinedRuns()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PionDDMC_CombinedRuns::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PionDDMC_CombinedRuns::LoadTree(Long64_t entry)
{
...
void PionDDMC_CombinedRuns::Init(TTree *tree)
{
...
Bool_t PionDDMC_CombinedRuns::Notify()
{
...
void PionDDMC_CombinedRuns::Show(Long64_t entry)
{
...
Int_t PionDDMC_CombinedRuns::Cut(Long64_t entry)
{
...
#endif // #ifdef PionDDMC_CombinedRuns_cxx

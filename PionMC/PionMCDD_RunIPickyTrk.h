...
// Mon Jun 19 08:49:41 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/DDMC_RunI_PickyTrkNegPol_PiMinus_anatree.root
//////////////////////////////////////////////////////////

#ifndef PionMCDD_RunIPickyTrk_h
#define PionMCDD_RunIPickyTrk_h
...
public :
   ...
   PionMCDD_RunIPickyTrk(TTree *tree=0);
   virtual ~PionMCDD_RunIPickyTrk();
...
#ifdef PionMCDD_RunIPickyTrk_cxx
PionMCDD_RunIPickyTrk::PionMCDD_RunIPickyTrk(TTree *tree) : fChain(0) 
{
...
PionMCDD_RunIPickyTrk::~PionMCDD_RunIPickyTrk()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PionMCDD_RunIPickyTrk::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PionMCDD_RunIPickyTrk::LoadTree(Long64_t entry)
{
...
void PionMCDD_RunIPickyTrk::Init(TTree *tree)
{
...
Bool_t PionMCDD_RunIPickyTrk::Notify()
{
...
void PionMCDD_RunIPickyTrk::Show(Long64_t entry)
{
...
Int_t PionMCDD_RunIPickyTrk::Cut(Long64_t entry)
{
...
#endif // #ifdef PionMCDD_RunIPickyTrk_cxx

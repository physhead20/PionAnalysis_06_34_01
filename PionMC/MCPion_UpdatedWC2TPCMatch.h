...
// Tue Feb 13 11:54:26 2018 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/reco_histo.root
//////////////////////////////////////////////////////////

#ifndef MCPion_UpdatedWC2TPCMatch_h
#define MCPion_UpdatedWC2TPCMatch_h
...
class MCPion_UpdatedWC2TPCMatch {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[58];   //[nclus]
   Double_t        clusterttick[58];   //[nclus]
   Double_t        cluendwire[58];   //[nclus]
   Double_t        cluendtick[58];   //[nclus]
   Int_t           cluplane[58];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[14];   //[ntracks_reco]
   Double_t        trkvtxy[14];   //[ntracks_reco]
   Double_t        trkvtxz[14];   //[ntracks_reco]
   Double_t        trkendx[14];   //[ntracks_reco]
   Double_t        trkendy[14];   //[ntracks_reco]
   Double_t        trkendz[14];   //[ntracks_reco]
   Double_t        trkstartdcosx[14];   //[ntracks_reco]
   Double_t        trkstartdcosy[14];   //[ntracks_reco]
   Double_t        trkstartdcosz[14];   //[ntracks_reco]
   Double_t        trkenddcosx[14];   //[ntracks_reco]
   Double_t        trkenddcosy[14];   //[ntracks_reco]
   Double_t        trkenddcosz[14];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[14];   //[ntracks_reco]
   Double_t        trklength[14];   //[ntracks_reco]
   Double_t        trkmomrange[14];   //[ntracks_reco]
   Double_t        trkmommschi2[14];   //[ntracks_reco]
   Double_t        trkmommsllhd[14];   //[ntracks_reco]
   Int_t           ntrkhits[14];   //[ntracks_reco]
   Double_t        trkx[14][1000];   //[ntracks_reco]
   Double_t        trky[14][1000];   //[ntracks_reco]
   Double_t        trkz[14][1000];   //[ntracks_reco]
   Double_t        trkpitch[14][2];   //[ntracks_reco]
   Int_t           trkhits[14][2];   //[ntracks_reco]
   Double_t        trkdedx[14][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[14][2][1000];   //[ntracks_reco]
   Double_t        trkrr[14][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[14][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[14][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[14][2];   //[ntracks_reco]
   Double_t        trkpida[14][2];   //[ntracks_reco]
   Int_t           nTrajPoint[14];   //[ntracks_reco]
   Double_t        pHat0_X[14][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[14][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[14][1000];   //[ntracks_reco]
   Double_t        trjPt_X[14][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[14][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[14][1000];   //[ntracks_reco]
   Int_t           trkg4id[14];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[542];   //[nhits]
   Int_t           hit_wire[542];   //[nhits]
   Int_t           hit_channel[542];   //[nhits]
   Double_t        hit_peakT[542];   //[nhits]
   Double_t        hit_charge[542];   //[nhits]
   Double_t        hit_ph[542];   //[nhits]
   Double_t        hit_tstart[542];   //[nhits]
   Double_t        hit_tend[542];   //[nhits]
   Int_t           hit_trkid[542];   //[nhits]
   Int_t           hit_trkkey[542];   //[nhits]
   Int_t           hit_clukey[542];   //[nhits]
   Int_t           hit_pk[542];   //[nhits]
   Int_t           hit_t[542];   //[nhits]
   Int_t           hit_ch[542];   //[nhits]
   Int_t           hit_fwhh[542];   //[nhits]
   Double_t        hit_rms[542];   //[nhits]
   Double_t        hit_nelec[542];   //[nhits]
   Double_t        hit_energy[542];   //[nhits]
   Float_t         hit_dQds[542];   //[nhits]
   Float_t         hit_dEds[542];   //[nhits]
   Float_t         hit_ds[542];   //[nhits]
   Float_t         hit_resrange[542];   //[nhits]
   Float_t         hit_x[542];   //[nhits]
   Float_t         hit_y[542];   //[nhits]
   Float_t         hit_z[542];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2298];   //[maxTrackIDE]
   Double_t        IDEPos[2298][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[147];   //[geant_list_size]
   Double_t        Eng[147];   //[geant_list_size]
   Double_t        Px[147];   //[geant_list_size]
   Double_t        Py[147];   //[geant_list_size]
   Double_t        Pz[147];   //[geant_list_size]
   Double_t        EndEng[147];   //[geant_list_size]
   Double_t        EndPx[147];   //[geant_list_size]
   Double_t        EndPy[147];   //[geant_list_size]
   Double_t        EndPz[147];   //[geant_list_size]
   Double_t        StartPointx[147];   //[geant_list_size]
   Double_t        StartPointy[147];   //[geant_list_size]
   Double_t        StartPointz[147];   //[geant_list_size]
   Double_t        EndPointx[147];   //[geant_list_size]
   Double_t        EndPointy[147];   //[geant_list_size]
   Double_t        EndPointz[147];   //[geant_list_size]
   Int_t           Process[147];   //[geant_list_size]
   Int_t           NumberDaughters[147];   //[geant_list_size]
   Int_t           Mother[147];   //[geant_list_size]
   Int_t           TrackId[147];   //[geant_list_size]
   Int_t           process_primary[147];   //[geant_list_size]
   ...
   MCPion_UpdatedWC2TPCMatch(TTree *tree=0);
   virtual ~MCPion_UpdatedWC2TPCMatch();
...
#ifdef MCPion_UpdatedWC2TPCMatch_cxx
MCPion_UpdatedWC2TPCMatch::MCPion_UpdatedWC2TPCMatch(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/reco_histo.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/reco_histo.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/reco_histo.root:/anatree");
...
MCPion_UpdatedWC2TPCMatch::~MCPion_UpdatedWC2TPCMatch()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCPion_UpdatedWC2TPCMatch::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCPion_UpdatedWC2TPCMatch::LoadTree(Long64_t entry)
{
...
void MCPion_UpdatedWC2TPCMatch::Init(TTree *tree)
{
...
Bool_t MCPion_UpdatedWC2TPCMatch::Notify()
{
...
void MCPion_UpdatedWC2TPCMatch::Show(Long64_t entry)
{
...
Int_t MCPion_UpdatedWC2TPCMatch::Cut(Long64_t entry)
{
...
#endif // #ifdef MCPion_UpdatedWC2TPCMatch_cxx

#define MCPion_UpdatedWC2TPCMatch_cxx
#include "MCPion_UpdatedWC2TPCMatch.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void MCPion_UpdatedWC2TPCMatch::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../histoROOTfiles_forPlots/DDMC_Pion_UpdatedWC2TPCMatch_histo.root","RECREATE");
...
\
   ...
   // ##############################################
   for(int a = 0; a < ntracks_reco; a++)
      {
      
      // ### Set the flag if trkWCtoTPCMatch[] is equal to 1 ###
      if(trkWCtoTPCMatch[a] == 1)
         {
	 MatchTPC_WVTrack[a] = true;
	 nMatchedTracks++;
	 
	 }//<---end setting the match

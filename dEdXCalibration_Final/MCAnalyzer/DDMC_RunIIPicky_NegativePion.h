...
// Fri Aug 11 08:50:40 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/DDMC_RunIINegPickyPion_anatree.root
//////////////////////////////////////////////////////////

#ifndef DDMC_RunIIPicky_NegativePion_h
#define DDMC_RunIIPicky_NegativePion_h
...
class DDMC_RunIIPicky_NegativePion {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[62];   //[nclus]
   Double_t        clusterttick[62];   //[nclus]
   Double_t        cluendwire[62];   //[nclus]
   Double_t        cluendtick[62];   //[nclus]
   Int_t           cluplane[62];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[22];   //[ntracks_reco]
   Double_t        trkvtxy[22];   //[ntracks_reco]
   Double_t        trkvtxz[22];   //[ntracks_reco]
   Double_t        trkendx[22];   //[ntracks_reco]
   Double_t        trkendy[22];   //[ntracks_reco]
   Double_t        trkendz[22];   //[ntracks_reco]
   Double_t        trkstartdcosx[22];   //[ntracks_reco]
   Double_t        trkstartdcosy[22];   //[ntracks_reco]
   Double_t        trkstartdcosz[22];   //[ntracks_reco]
   Double_t        trkenddcosx[22];   //[ntracks_reco]
   Double_t        trkenddcosy[22];   //[ntracks_reco]
   Double_t        trkenddcosz[22];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[22];   //[ntracks_reco]
   Double_t        trklength[22];   //[ntracks_reco]
   Double_t        trkmomrange[22];   //[ntracks_reco]
   Double_t        trkmommschi2[22];   //[ntracks_reco]
   Double_t        trkmommsllhd[22];   //[ntracks_reco]
   Int_t           ntrkhits[22];   //[ntracks_reco]
   Double_t        trkx[22][1000];   //[ntracks_reco]
   Double_t        trky[22][1000];   //[ntracks_reco]
   Double_t        trkz[22][1000];   //[ntracks_reco]
   Double_t        trkpitch[22][2];   //[ntracks_reco]
   Int_t           trkhits[22][2];   //[ntracks_reco]
   Double_t        trkdedx[22][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[22][2][1000];   //[ntracks_reco]
   Double_t        trkrr[22][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[22][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[22][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[22][2];   //[ntracks_reco]
   Double_t        trkpida[22][2];   //[ntracks_reco]
   Int_t           nTrajPoint[22];   //[ntracks_reco]
   Double_t        pHat0_X[22][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[22][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[22][1000];   //[ntracks_reco]
   Double_t        trjPt_X[22][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[22][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[22][1000];   //[ntracks_reco]
   Int_t           trkg4id[22];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[969];   //[nhits]
   Int_t           hit_wire[969];   //[nhits]
   Int_t           hit_channel[969];   //[nhits]
   Double_t        hit_peakT[969];   //[nhits]
   Double_t        hit_charge[969];   //[nhits]
   Double_t        hit_ph[969];   //[nhits]
   Double_t        hit_tstart[969];   //[nhits]
   Double_t        hit_tend[969];   //[nhits]
   Int_t           hit_trkid[969];   //[nhits]
   Int_t           hit_trkkey[969];   //[nhits]
   Int_t           hit_clukey[969];   //[nhits]
   Int_t           hit_pk[969];   //[nhits]
   Int_t           hit_t[969];   //[nhits]
   Int_t           hit_ch[969];   //[nhits]
   Int_t           hit_fwhh[969];   //[nhits]
   Double_t        hit_rms[969];   //[nhits]
   Double_t        hit_nelec[969];   //[nhits]
   Double_t        hit_energy[969];   //[nhits]
   Float_t         hit_dQds[969];   //[nhits]
   Float_t         hit_dEds[969];   //[nhits]
   Float_t         hit_ds[969];   //[nhits]
   Float_t         hit_resrange[969];   //[nhits]
   Float_t         hit_x[969];   //[nhits]
   Float_t         hit_y[969];   //[nhits]
   Float_t         hit_z[969];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[4202];   //[maxTrackIDE]
   Double_t        IDEPos[4202][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   ...
   DDMC_RunIIPicky_NegativePion(TTree *tree=0);
   virtual ~DDMC_RunIIPicky_NegativePion();
...
#ifdef DDMC_RunIIPicky_NegativePion_cxx
DDMC_RunIIPicky_NegativePion::DDMC_RunIIPicky_NegativePion(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/DDMC_RunIINegPickyPion_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/DDMC_RunIINegPickyPion_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/DDMC_RunIINegPickyPion_anatree.root:/anatree");
...
DDMC_RunIIPicky_NegativePion::~DDMC_RunIIPicky_NegativePion()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DDMC_RunIIPicky_NegativePion::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DDMC_RunIIPicky_NegativePion::LoadTree(Long64_t entry)
{
...
void DDMC_RunIIPicky_NegativePion::Init(TTree *tree)
{
...
Bool_t DDMC_RunIIPicky_NegativePion::Notify()
{
...
void DDMC_RunIIPicky_NegativePion::Show(Long64_t entry)
{
...
Int_t DDMC_RunIIPicky_NegativePion::Cut(Long64_t entry)
{
...
#endif // #ifdef DDMC_RunIIPicky_NegativePion_cxx

...
// Mon Aug  7 12:54:59 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/DDMC_RunI_PickyTrkNegPol_PiMinus_anatree.root
//////////////////////////////////////////////////////////

#ifndef DDMC_RunIPicky_PiMuE_h
#define DDMC_RunIPicky_PiMuE_h
...
public :
   ...
   DDMC_RunIPicky_PiMuE(TTree *tree=0);
   virtual ~DDMC_RunIPicky_PiMuE();
...
#ifdef DDMC_RunIPicky_PiMuE_cxx
DDMC_RunIPicky_PiMuE::DDMC_RunIPicky_PiMuE(TTree *tree) : fChain(0) 
{
...
DDMC_RunIPicky_PiMuE::~DDMC_RunIPicky_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DDMC_RunIPicky_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DDMC_RunIPicky_PiMuE::LoadTree(Long64_t entry)
{
...
void DDMC_RunIPicky_PiMuE::Init(TTree *tree)
{
...
Bool_t DDMC_RunIPicky_PiMuE::Notify()
{
...
void DDMC_RunIPicky_PiMuE::Show(Long64_t entry)
{
...
Int_t DDMC_RunIPicky_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef DDMC_RunIPicky_PiMuE_cxx

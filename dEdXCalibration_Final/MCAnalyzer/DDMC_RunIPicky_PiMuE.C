#define DDMC_RunIPicky_PiMuE_cxx
#include "DDMC_RunIPicky_PiMuE.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void DDMC_RunIPicky_PiMuE::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_DDMC_RunIPicky_PiMinus_Collection.root","RECREATE");

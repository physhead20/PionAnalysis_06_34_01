...
// Wed Aug  9 18:03:11 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/DDMC_RunI_PickyTrkPosPol_Proton_anatree.root
//////////////////////////////////////////////////////////

#ifndef DDMC_RunIPicky_Proton_h
#define DDMC_RunIPicky_Proton_h
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[45];   //[nclus]
   Double_t        clusterttick[45];   //[nclus]
   Double_t        cluendwire[45];   //[nclus]
   Double_t        cluendtick[45];   //[nclus]
   Int_t           cluplane[45];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[572];   //[nhits]
   Int_t           hit_wire[572];   //[nhits]
   Int_t           hit_channel[572];   //[nhits]
   Double_t        hit_peakT[572];   //[nhits]
   Double_t        hit_charge[572];   //[nhits]
   Double_t        hit_ph[572];   //[nhits]
   Double_t        hit_tstart[572];   //[nhits]
   Double_t        hit_tend[572];   //[nhits]
   Int_t           hit_trkid[572];   //[nhits]
   Int_t           hit_trkkey[572];   //[nhits]
   Int_t           hit_clukey[572];   //[nhits]
   Int_t           hit_pk[572];   //[nhits]
   Int_t           hit_t[572];   //[nhits]
   Int_t           hit_ch[572];   //[nhits]
   Int_t           hit_fwhh[572];   //[nhits]
   Double_t        hit_rms[572];   //[nhits]
   Double_t        hit_nelec[572];   //[nhits]
   Double_t        hit_energy[572];   //[nhits]
   Float_t         hit_dQds[572];   //[nhits]
   Float_t         hit_dEds[572];   //[nhits]
   Float_t         hit_ds[572];   //[nhits]
   Float_t         hit_resrange[572];   //[nhits]
   Float_t         hit_x[572];   //[nhits]
   Float_t         hit_y[572];   //[nhits]
   Float_t         hit_z[572];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2490];   //[maxTrackIDE]
   Double_t        IDEPos[2490][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[154];   //[geant_list_size]
   Double_t        Eng[154];   //[geant_list_size]
   Double_t        Px[154];   //[geant_list_size]
   Double_t        Py[154];   //[geant_list_size]
   Double_t        Pz[154];   //[geant_list_size]
   Double_t        EndEng[154];   //[geant_list_size]
   Double_t        EndPx[154];   //[geant_list_size]
   Double_t        EndPy[154];   //[geant_list_size]
   Double_t        EndPz[154];   //[geant_list_size]
   Double_t        StartPointx[154];   //[geant_list_size]
   Double_t        StartPointy[154];   //[geant_list_size]
   Double_t        StartPointz[154];   //[geant_list_size]
   Double_t        EndPointx[154];   //[geant_list_size]
   Double_t        EndPointy[154];   //[geant_list_size]
   Double_t        EndPointz[154];   //[geant_list_size]
   Int_t           Process[154];   //[geant_list_size]
   Int_t           NumberDaughters[154];   //[geant_list_size]
   Int_t           Mother[154];   //[geant_list_size]
   Int_t           TrackId[154];   //[geant_list_size]
   Int_t           process_primary[154];   //[geant_list_size]
   ...
   DDMC_RunIPicky_Proton(TTree *tree=0);
   virtual ~DDMC_RunIPicky_Proton();
...
#ifdef DDMC_RunIPicky_Proton_cxx
DDMC_RunIPicky_Proton::DDMC_RunIPicky_Proton(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/DDMC_RunI_PickyTrkPosPol_Proton_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/DDMC_RunI_PickyTrkPosPol_Proton_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/DDMC_RunI_PickyTrkPosPol_Proton_anatree.root:/anatree");
...
DDMC_RunIPicky_Proton::~DDMC_RunIPicky_Proton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DDMC_RunIPicky_Proton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DDMC_RunIPicky_Proton::LoadTree(Long64_t entry)
{
...
void DDMC_RunIPicky_Proton::Init(TTree *tree)
{
...
Bool_t DDMC_RunIPicky_Proton::Notify()
{
...
void DDMC_RunIPicky_Proton::Show(Long64_t entry)
{
...
Int_t DDMC_RunIPicky_Proton::Cut(Long64_t entry)
{
...
#endif // #ifdef DDMC_RunIPicky_Proton_cxx

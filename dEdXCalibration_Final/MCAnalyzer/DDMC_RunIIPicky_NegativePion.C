#define DDMC_RunIIPicky_NegativePion_cxx
#include "DDMC_RunIIPicky_NegativePion.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void DDMC_RunIIPicky_NegativePion::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_DDMC_RunIIPicky_PiMinus_Collection.root","RECREATE");

//TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_DDMC_RunIIPicky_PiMinus_Induction.root","RECREATE");

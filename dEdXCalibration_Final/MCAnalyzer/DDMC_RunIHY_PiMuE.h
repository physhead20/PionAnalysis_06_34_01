...
// Wed Aug  9 16:04:07 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/DDMC_RunI_HYTrkNegPol_PiMinus_anatree.root
//////////////////////////////////////////////////////////

#ifndef DDMC_RunIHY_PiMuE_h
#define DDMC_RunIHY_PiMuE_h
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[69];   //[nclus]
   Double_t        clusterttick[69];   //[nclus]
   Double_t        cluendwire[69];   //[nclus]
   Double_t        cluendtick[69];   //[nclus]
   Int_t           cluplane[69];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[18];   //[ntracks_reco]
   Double_t        trkvtxy[18];   //[ntracks_reco]
   Double_t        trkvtxz[18];   //[ntracks_reco]
   Double_t        trkendx[18];   //[ntracks_reco]
   Double_t        trkendy[18];   //[ntracks_reco]
   Double_t        trkendz[18];   //[ntracks_reco]
   Double_t        trkstartdcosx[18];   //[ntracks_reco]
   Double_t        trkstartdcosy[18];   //[ntracks_reco]
   Double_t        trkstartdcosz[18];   //[ntracks_reco]
   Double_t        trkenddcosx[18];   //[ntracks_reco]
   Double_t        trkenddcosy[18];   //[ntracks_reco]
   Double_t        trkenddcosz[18];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[18];   //[ntracks_reco]
   Double_t        trklength[18];   //[ntracks_reco]
   Double_t        trkmomrange[18];   //[ntracks_reco]
   Double_t        trkmommschi2[18];   //[ntracks_reco]
   Double_t        trkmommsllhd[18];   //[ntracks_reco]
   Int_t           ntrkhits[18];   //[ntracks_reco]
   Double_t        trkx[18][1000];   //[ntracks_reco]
   Double_t        trky[18][1000];   //[ntracks_reco]
   Double_t        trkz[18][1000];   //[ntracks_reco]
   Double_t        trkpitch[18][2];   //[ntracks_reco]
   Int_t           trkhits[18][2];   //[ntracks_reco]
   Double_t        trkdedx[18][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[18][2][1000];   //[ntracks_reco]
   Double_t        trkrr[18][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[18][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[18][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[18][2];   //[ntracks_reco]
   Double_t        trkpida[18][2];   //[ntracks_reco]
   Int_t           nTrajPoint[18];   //[ntracks_reco]
   Double_t        pHat0_X[18][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[18][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[18][1000];   //[ntracks_reco]
   Double_t        trjPt_X[18][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[18][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[18][1000];   //[ntracks_reco]
   Int_t           trkg4id[18];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[964];   //[nhits]
   Int_t           hit_wire[964];   //[nhits]
   Int_t           hit_channel[964];   //[nhits]
   Double_t        hit_peakT[964];   //[nhits]
   Double_t        hit_charge[964];   //[nhits]
   Double_t        hit_ph[964];   //[nhits]
   Double_t        hit_tstart[964];   //[nhits]
   Double_t        hit_tend[964];   //[nhits]
   Int_t           hit_trkid[964];   //[nhits]
   Int_t           hit_trkkey[964];   //[nhits]
   Int_t           hit_clukey[964];   //[nhits]
   Int_t           hit_pk[964];   //[nhits]
   Int_t           hit_t[964];   //[nhits]
   Int_t           hit_ch[964];   //[nhits]
   Int_t           hit_fwhh[964];   //[nhits]
   Double_t        hit_rms[964];   //[nhits]
   Double_t        hit_nelec[964];   //[nhits]
   Double_t        hit_energy[964];   //[nhits]
   Float_t         hit_dQds[964];   //[nhits]
   Float_t         hit_dEds[964];   //[nhits]
   Float_t         hit_ds[964];   //[nhits]
   Float_t         hit_resrange[964];   //[nhits]
   Float_t         hit_x[964];   //[nhits]
   Float_t         hit_y[964];   //[nhits]
   Float_t         hit_z[964];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[4128];   //[maxTrackIDE]
   Double_t        IDEPos[4128][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[264];   //[geant_list_size]
   Double_t        Eng[264];   //[geant_list_size]
   Double_t        Px[264];   //[geant_list_size]
   Double_t        Py[264];   //[geant_list_size]
   Double_t        Pz[264];   //[geant_list_size]
   Double_t        EndEng[264];   //[geant_list_size]
   Double_t        EndPx[264];   //[geant_list_size]
   Double_t        EndPy[264];   //[geant_list_size]
   Double_t        EndPz[264];   //[geant_list_size]
   Double_t        StartPointx[264];   //[geant_list_size]
   Double_t        StartPointy[264];   //[geant_list_size]
   Double_t        StartPointz[264];   //[geant_list_size]
   Double_t        EndPointx[264];   //[geant_list_size]
   Double_t        EndPointy[264];   //[geant_list_size]
   Double_t        EndPointz[264];   //[geant_list_size]
   Int_t           Process[264];   //[geant_list_size]
   Int_t           NumberDaughters[264];   //[geant_list_size]
   Int_t           Mother[264];   //[geant_list_size]
   Int_t           TrackId[264];   //[geant_list_size]
   Int_t           process_primary[264];   //[geant_list_size]
   ...
   DDMC_RunIHY_PiMuE(TTree *tree=0);
   virtual ~DDMC_RunIHY_PiMuE();
...
#ifdef DDMC_RunIHY_PiMuE_cxx
DDMC_RunIHY_PiMuE::DDMC_RunIHY_PiMuE(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/DDMC_RunI_HYTrkNegPol_PiMinus_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/DDMC_RunI_HYTrkNegPol_PiMinus_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/DDMC_RunI_HYTrkNegPol_PiMinus_anatree.root:/anatree");
...
DDMC_RunIHY_PiMuE::~DDMC_RunIHY_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DDMC_RunIHY_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DDMC_RunIHY_PiMuE::LoadTree(Long64_t entry)
{
...
void DDMC_RunIHY_PiMuE::Init(TTree *tree)
{
...
Bool_t DDMC_RunIHY_PiMuE::Notify()
{
...
void DDMC_RunIHY_PiMuE::Show(Long64_t entry)
{
...
Int_t DDMC_RunIHY_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef DDMC_RunIHY_PiMuE_cxx

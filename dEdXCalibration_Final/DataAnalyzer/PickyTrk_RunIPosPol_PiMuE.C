#define PickyTrk_RunIPosPol_PiMuE_cxx
#include "PickyTrk_RunIPosPol_PiMuE.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PickyTrk_RunIPosPol_PiMuE::Loop()
{
if (fChain == 0) return;
...
//TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIPos_Picky_PiMuE_Collection.root","RECREATE");
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIPos_Picky_PiMuE_Induction.root","RECREATE");

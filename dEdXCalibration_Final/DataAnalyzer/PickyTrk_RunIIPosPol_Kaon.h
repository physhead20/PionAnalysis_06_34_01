...
// Sun Aug  6 08:15:07 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunII_Kaon_PosPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIIPosPol_Kaon_h
#define PickyTrk_RunIIPosPol_Kaon_h
...
class PickyTrk_RunIIPosPol_Kaon {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[177];   //[nclus]
   Double_t        clusterttick[177];   //[nclus]
   Double_t        cluendwire[177];   //[nclus]
   Double_t        cluendtick[177];   //[nclus]
   Int_t           cluplane[177];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           trkWCtoTPCMatch[42];   //[ntracks_reco]
   Double_t        trklength[42];   //[ntracks_reco]
   Double_t        trkmomrange[42];   //[ntracks_reco]
   Double_t        trkmommschi2[42];   //[ntracks_reco]
   Double_t        trkmommsllhd[42];   //[ntracks_reco]
   Int_t           ntrkhits[42];   //[ntracks_reco]
   Double_t        trkx[42][1000];   //[ntracks_reco]
   Double_t        trky[42][1000];   //[ntracks_reco]
   Double_t        trkz[42][1000];   //[ntracks_reco]
   Double_t        trkpitch[42][2];   //[ntracks_reco]
   Int_t           trkhits[42][2];   //[ntracks_reco]
   Double_t        trkdedx[42][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[42][2][1000];   //[ntracks_reco]
   Double_t        trkrr[42][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[42][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[42][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[42][2];   //[ntracks_reco]
   Double_t        trkpida[42][2];   //[ntracks_reco]
   Int_t           nTrajPoint[42];   //[ntracks_reco]
   Double_t        pHat0_X[42][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[42][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[42][1000];   //[ntracks_reco]
   Double_t        trjPt_X[42][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[42][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[42][1000];   //[ntracks_reco]
   Int_t           trkg4id[42];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[8090];   //[nhits]
   Int_t           hit_wire[8090];   //[nhits]
   Int_t           hit_channel[8090];   //[nhits]
   Double_t        hit_peakT[8090];   //[nhits]
   Double_t        hit_charge[8090];   //[nhits]
   Double_t        hit_ph[8090];   //[nhits]
   Double_t        hit_tstart[8090];   //[nhits]
   Double_t        hit_tend[8090];   //[nhits]
   Int_t           hit_trkid[8090];   //[nhits]
   Int_t           hit_trkkey[8090];   //[nhits]
   Int_t           hit_clukey[8090];   //[nhits]
   Int_t           hit_pk[8090];   //[nhits]
   Int_t           hit_t[8090];   //[nhits]
   Int_t           hit_ch[8090];   //[nhits]
   Int_t           hit_fwhh[8090];   //[nhits]
   Double_t        hit_rms[8090];   //[nhits]
   Double_t        hit_nelec[8090];   //[nhits]
   Double_t        hit_energy[8090];   //[nhits]
   Float_t         hit_dQds[8090];   //[nhits]
   Float_t         hit_dEds[8090];   //[nhits]
   Float_t         hit_ds[8090];   //[nhits]
   Float_t         hit_resrange[8090];   //[nhits]
   Float_t         hit_x[8090];   //[nhits]
   Float_t         hit_y[8090];   //[nhits]
   Float_t         hit_z[8090];   //[nhits]
   Int_t           nwctrks;
   ...
   PickyTrk_RunIIPosPol_Kaon(TTree *tree=0);
   virtual ~PickyTrk_RunIIPosPol_Kaon();
...
#ifdef PickyTrk_RunIIPosPol_Kaon_cxx
PickyTrk_RunIIPosPol_Kaon::PickyTrk_RunIIPosPol_Kaon(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunII_Kaon_PosPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunII_Kaon_PosPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunII_Kaon_PosPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIIPosPol_Kaon::~PickyTrk_RunIIPosPol_Kaon()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIIPosPol_Kaon::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIIPosPol_Kaon::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIIPosPol_Kaon::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIIPosPol_Kaon::Notify()
{
...
void PickyTrk_RunIIPosPol_Kaon::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIIPosPol_Kaon::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIIPosPol_Kaon_cxx

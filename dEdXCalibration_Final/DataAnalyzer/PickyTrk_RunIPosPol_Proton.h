...
// Thu Aug  3 14:39:39 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunI_Proton_PosPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIPosPol_Proton_h
#define PickyTrk_RunIPosPol_Proton_h
...
class PickyTrk_RunIPosPol_Proton {
public :
   ...
   PickyTrk_RunIPosPol_Proton(TTree *tree=0);
   virtual ~PickyTrk_RunIPosPol_Proton();
...
#ifdef PickyTrk_RunIPosPol_Proton_cxx
PickyTrk_RunIPosPol_Proton::PickyTrk_RunIPosPol_Proton(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunI_Proton_PosPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunI_Proton_PosPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunI_Proton_PosPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIPosPol_Proton::~PickyTrk_RunIPosPol_Proton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIPosPol_Proton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIPosPol_Proton::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIPosPol_Proton::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIPosPol_Proton::Notify()
{
...
void PickyTrk_RunIPosPol_Proton::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIPosPol_Proton::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIPosPol_Proton_cxx

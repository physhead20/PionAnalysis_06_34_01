...
// Sun Aug  6 09:19:47 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunII_Kaon_NegPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIINegPol_Kaon_h
#define PickyTrk_RunIINegPol_Kaon_h
...
class PickyTrk_RunIINegPol_Kaon {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[368];   //[nclus]
   Double_t        clusterttick[368];   //[nclus]
   Double_t        cluendwire[368];   //[nclus]
   Double_t        cluendtick[368];   //[nclus]
   Int_t           cluplane[368];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[70];   //[ntracks_reco]
   Double_t        trkvtxy[70];   //[ntracks_reco]
   Double_t        trkvtxz[70];   //[ntracks_reco]
   Double_t        trkendx[70];   //[ntracks_reco]
   Double_t        trkendy[70];   //[ntracks_reco]
   Double_t        trkendz[70];   //[ntracks_reco]
   Double_t        trkstartdcosx[70];   //[ntracks_reco]
   Double_t        trkstartdcosy[70];   //[ntracks_reco]
   Double_t        trkstartdcosz[70];   //[ntracks_reco]
   Double_t        trkenddcosx[70];   //[ntracks_reco]
   Double_t        trkenddcosy[70];   //[ntracks_reco]
   Double_t        trkenddcosz[70];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[70];   //[ntracks_reco]
   Double_t        trklength[70];   //[ntracks_reco]
   Double_t        trkmomrange[70];   //[ntracks_reco]
   Double_t        trkmommschi2[70];   //[ntracks_reco]
   Double_t        trkmommsllhd[70];   //[ntracks_reco]
   Int_t           ntrkhits[70];   //[ntracks_reco]
   Double_t        trkx[70][1000];   //[ntracks_reco]
   Double_t        trky[70][1000];   //[ntracks_reco]
   Double_t        trkz[70][1000];   //[ntracks_reco]
   Double_t        trkpitch[70][2];   //[ntracks_reco]
   Int_t           trkhits[70][2];   //[ntracks_reco]
   Double_t        trkdedx[70][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[70][2][1000];   //[ntracks_reco]
   Double_t        trkrr[70][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[70][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[70][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[70][2];   //[ntracks_reco]
   Double_t        trkpida[70][2];   //[ntracks_reco]
   Int_t           nTrajPoint[70];   //[ntracks_reco]
   Double_t        pHat0_X[70][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[70][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[70][1000];   //[ntracks_reco]
   Double_t        trjPt_X[70][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[70][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[70][1000];   //[ntracks_reco]
   Int_t           trkg4id[70];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[12073];   //[nhits]
   Int_t           hit_wire[12073];   //[nhits]
   Int_t           hit_channel[12073];   //[nhits]
   Double_t        hit_peakT[12073];   //[nhits]
   Double_t        hit_charge[12073];   //[nhits]
   Double_t        hit_ph[12073];   //[nhits]
   Double_t        hit_tstart[12073];   //[nhits]
   Double_t        hit_tend[12073];   //[nhits]
   Int_t           hit_trkid[12073];   //[nhits]
   Int_t           hit_trkkey[12073];   //[nhits]
   Int_t           hit_clukey[12073];   //[nhits]
   Int_t           hit_pk[12073];   //[nhits]
   Int_t           hit_t[12073];   //[nhits]
   Int_t           hit_ch[12073];   //[nhits]
   Int_t           hit_fwhh[12073];   //[nhits]
   Double_t        hit_rms[12073];   //[nhits]
   Double_t        hit_nelec[12073];   //[nhits]
   Double_t        hit_energy[12073];   //[nhits]
   Float_t         hit_dQds[12073];   //[nhits]
   Float_t         hit_dEds[12073];   //[nhits]
   Float_t         hit_ds[12073];   //[nhits]
   Float_t         hit_resrange[12073];   //[nhits]
   Float_t         hit_x[12073];   //[nhits]
   Float_t         hit_y[12073];   //[nhits]
   Float_t         hit_z[12073];   //[nhits]
   Int_t           nwctrks;
   ...
   PickyTrk_RunIINegPol_Kaon(TTree *tree=0);
   virtual ~PickyTrk_RunIINegPol_Kaon();
...
#ifdef PickyTrk_RunIINegPol_Kaon_cxx
PickyTrk_RunIINegPol_Kaon::PickyTrk_RunIINegPol_Kaon(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunII_Kaon_NegPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunII_Kaon_NegPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunII_Kaon_NegPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIINegPol_Kaon::~PickyTrk_RunIINegPol_Kaon()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIINegPol_Kaon::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIINegPol_Kaon::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIINegPol_Kaon::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIINegPol_Kaon::Notify()
{
...
void PickyTrk_RunIINegPol_Kaon::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIINegPol_Kaon::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIINegPol_Kaon_cxx

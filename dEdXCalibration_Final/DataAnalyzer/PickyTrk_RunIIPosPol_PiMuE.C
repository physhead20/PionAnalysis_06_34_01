#define PickyTrk_RunIIPosPol_PiMuE_cxx
#include "PickyTrk_RunIIPosPol_PiMuE.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PickyTrk_RunIIPosPol_PiMuE::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIIPos_Picky_PiMuE_Collection.root","RECREATE");

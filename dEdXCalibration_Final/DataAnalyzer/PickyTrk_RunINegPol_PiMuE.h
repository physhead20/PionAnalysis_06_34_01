...
// Sun Aug  6 10:27:12 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunINegPol_PiMuE_h
#define PickyTrk_RunINegPol_PiMuE_h
...
class PickyTrk_RunINegPol_PiMuE {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[427];   //[nclus]
   Double_t        clusterttick[427];   //[nclus]
   Double_t        cluendwire[427];   //[nclus]
   Double_t        cluendtick[427];   //[nclus]
   Int_t           cluplane[427];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[78];   //[ntracks_reco]
   Double_t        trkvtxy[78];   //[ntracks_reco]
   Double_t        trkvtxz[78];   //[ntracks_reco]
   Double_t        trkendx[78];   //[ntracks_reco]
   Double_t        trkendy[78];   //[ntracks_reco]
   Double_t        trkendz[78];   //[ntracks_reco]
   Double_t        trkstartdcosx[78];   //[ntracks_reco]
   Double_t        trkstartdcosy[78];   //[ntracks_reco]
   Double_t        trkstartdcosz[78];   //[ntracks_reco]
   Double_t        trkenddcosx[78];   //[ntracks_reco]
   Double_t        trkenddcosy[78];   //[ntracks_reco]
   Double_t        trkenddcosz[78];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[78];   //[ntracks_reco]
   Double_t        trklength[78];   //[ntracks_reco]
   Double_t        trkmomrange[78];   //[ntracks_reco]
   Double_t        trkmommschi2[78];   //[ntracks_reco]
   Double_t        trkmommsllhd[78];   //[ntracks_reco]
   Int_t           ntrkhits[78];   //[ntracks_reco]
   Double_t        trkx[78][1000];   //[ntracks_reco]
   Double_t        trky[78][1000];   //[ntracks_reco]
   Double_t        trkz[78][1000];   //[ntracks_reco]
   Double_t        trkpitch[78][2];   //[ntracks_reco]
   Int_t           trkhits[78][2];   //[ntracks_reco]
   Double_t        trkdedx[78][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[78][2][1000];   //[ntracks_reco]
   Double_t        trkrr[78][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[78][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[78][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[78][2];   //[ntracks_reco]
   Double_t        trkpida[78][2];   //[ntracks_reco]
   Int_t           nTrajPoint[78];   //[ntracks_reco]
   Double_t        pHat0_X[78][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[78][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[78][1000];   //[ntracks_reco]
   Double_t        trjPt_X[78][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[78][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[78][1000];   //[ntracks_reco]
   Int_t           trkg4id[78];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[15446];   //[nhits]
   Int_t           hit_wire[15446];   //[nhits]
   Int_t           hit_channel[15446];   //[nhits]
   Double_t        hit_peakT[15446];   //[nhits]
   Double_t        hit_charge[15446];   //[nhits]
   Double_t        hit_ph[15446];   //[nhits]
   Double_t        hit_tstart[15446];   //[nhits]
   Double_t        hit_tend[15446];   //[nhits]
   Int_t           hit_trkid[15446];   //[nhits]
   Int_t           hit_trkkey[15446];   //[nhits]
   Int_t           hit_clukey[15446];   //[nhits]
   Int_t           hit_pk[15446];   //[nhits]
   Int_t           hit_t[15446];   //[nhits]
   Int_t           hit_ch[15446];   //[nhits]
   Int_t           hit_fwhh[15446];   //[nhits]
   Double_t        hit_rms[15446];   //[nhits]
   Double_t        hit_nelec[15446];   //[nhits]
   Double_t        hit_energy[15446];   //[nhits]
   Float_t         hit_dQds[15446];   //[nhits]
   Float_t         hit_dEds[15446];   //[nhits]
   Float_t         hit_ds[15446];   //[nhits]
   Float_t         hit_resrange[15446];   //[nhits]
   Float_t         hit_x[15446];   //[nhits]
   Float_t         hit_y[15446];   //[nhits]
   Float_t         hit_z[15446];   //[nhits]
   Int_t           nwctrks;
   ...
   PickyTrk_RunINegPol_PiMuE(TTree *tree=0);
   virtual ~PickyTrk_RunINegPol_PiMuE();
...
#ifdef PickyTrk_RunINegPol_PiMuE_cxx
PickyTrk_RunINegPol_PiMuE::PickyTrk_RunINegPol_PiMuE(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunINegPol_PiMuE::~PickyTrk_RunINegPol_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunINegPol_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunINegPol_PiMuE::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunINegPol_PiMuE::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunINegPol_PiMuE::Notify()
{
...
void PickyTrk_RunINegPol_PiMuE::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunINegPol_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunINegPol_PiMuE_cxx

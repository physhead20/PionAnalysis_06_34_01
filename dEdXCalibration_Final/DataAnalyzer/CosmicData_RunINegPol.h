...
// Sun Aug  6 14:13:51 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/Cosmic_RunI_NegPol_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef CosmicData_RunINegPol_h
#define CosmicData_RunINegPol_h
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[611];   //[nclus]
   Double_t        clusterttick[611];   //[nclus]
   Double_t        cluendwire[611];   //[nclus]
   Double_t        cluendtick[611];   //[nclus]
   Int_t           cluplane[611];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[160];   //[ntracks_reco]
   Double_t        trkvtxy[160];   //[ntracks_reco]
   Double_t        trkvtxz[160];   //[ntracks_reco]
   Double_t        trkendx[160];   //[ntracks_reco]
   Double_t        trkendy[160];   //[ntracks_reco]
   Double_t        trkendz[160];   //[ntracks_reco]
   Double_t        trkstartdcosx[160];   //[ntracks_reco]
   Double_t        trkstartdcosy[160];   //[ntracks_reco]
   Double_t        trkstartdcosz[160];   //[ntracks_reco]
   Double_t        trkenddcosx[160];   //[ntracks_reco]
   Double_t        trkenddcosy[160];   //[ntracks_reco]
   Double_t        trkenddcosz[160];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[160];   //[ntracks_reco]
   Double_t        trklength[160];   //[ntracks_reco]
   Double_t        trkmomrange[160];   //[ntracks_reco]
   Double_t        trkmommschi2[160];   //[ntracks_reco]
   Double_t        trkmommsllhd[160];   //[ntracks_reco]
   Int_t           ntrkhits[160];   //[ntracks_reco]
   Double_t        trkx[160][1000];   //[ntracks_reco]
   Double_t        trky[160][1000];   //[ntracks_reco]
   Double_t        trkz[160][1000];   //[ntracks_reco]
   Double_t        trkpitch[160][2];   //[ntracks_reco]
   Int_t           trkhits[160][2];   //[ntracks_reco]
   Double_t        trkdedx[160][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[160][2][1000];   //[ntracks_reco]
   Double_t        trkrr[160][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[160][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[160][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[160][2];   //[ntracks_reco]
   Double_t        trkpida[160][2];   //[ntracks_reco]
   Int_t           nTrajPoint[160];   //[ntracks_reco]
   Double_t        pHat0_X[160][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[160][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[160][1000];   //[ntracks_reco]
   Double_t        trjPt_X[160][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[160][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[160][1000];   //[ntracks_reco]
   Int_t           trkg4id[160];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[18171];   //[nhits]
   Int_t           hit_wire[18171];   //[nhits]
   Int_t           hit_channel[18171];   //[nhits]
   Double_t        hit_peakT[18171];   //[nhits]
   Double_t        hit_charge[18171];   //[nhits]
   Double_t        hit_ph[18171];   //[nhits]
   Double_t        hit_tstart[18171];   //[nhits]
   Double_t        hit_tend[18171];   //[nhits]
   Int_t           hit_trkid[18171];   //[nhits]
   Int_t           hit_trkkey[18171];   //[nhits]
   Int_t           hit_clukey[18171];   //[nhits]
   Int_t           hit_pk[18171];   //[nhits]
   Int_t           hit_t[18171];   //[nhits]
   Int_t           hit_ch[18171];   //[nhits]
   Int_t           hit_fwhh[18171];   //[nhits]
   Double_t        hit_rms[18171];   //[nhits]
   Double_t        hit_nelec[18171];   //[nhits]
   Double_t        hit_energy[18171];   //[nhits]
   Float_t         hit_dQds[18171];   //[nhits]
   Float_t         hit_dEds[18171];   //[nhits]
   Float_t         hit_ds[18171];   //[nhits]
   Float_t         hit_resrange[18171];   //[nhits]
   Float_t         hit_x[18171];   //[nhits]
   Float_t         hit_y[18171];   //[nhits]
   Float_t         hit_z[18171];   //[nhits]
   Int_t           nwctrks;
   ...
   CosmicData_RunINegPol(TTree *tree=0);
   virtual ~CosmicData_RunINegPol();
...
#ifdef CosmicData_RunINegPol_cxx
CosmicData_RunINegPol::CosmicData_RunINegPol(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/Cosmic_RunI_NegPol_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/Cosmic_RunI_NegPol_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/Cosmic_RunI_NegPol_v06_34_01_anatree.root:/anatree");
...
CosmicData_RunINegPol::~CosmicData_RunINegPol()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CosmicData_RunINegPol::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CosmicData_RunINegPol::LoadTree(Long64_t entry)
{
...
void CosmicData_RunINegPol::Init(TTree *tree)
{
...
Bool_t CosmicData_RunINegPol::Notify()
{
...
void CosmicData_RunINegPol::Show(Long64_t entry)
{
...
Int_t CosmicData_RunINegPol::Cut(Long64_t entry)
{
...
#endif // #ifdef CosmicData_RunINegPol_cxx

#define PickyTrk_RunIINegPol_PiMuE_cxx
#include "PickyTrk_RunIINegPol_PiMuE.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PickyTrk_RunIINegPol_PiMuE::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIINeg_Picky_PiMuE_Collection.root","RECREATE");
//TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIINeg_Picky_PiMuE_Induction.root","RECREATE");

#define PickyTrk_RunIPosPol_Proton_cxx
#include "PickyTrk_RunIPosPol_Proton.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PickyTrk_RunIPosPol_Proton::Loop()
{
if (fChain == 0) return;
...
int nEvtsWCTrackMatch = 0, nEvtsThroughGoing = 0, nNonShowerEvents = 0;
...
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIPos_Picky_Proton_Collection.root","RECREATE");
//TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIPos_Picky_Proton_Induction.root","RECREATE");
...
std::cout<<"Events not Shower Like        = "<<nNonShowerEvents<<std::endl;

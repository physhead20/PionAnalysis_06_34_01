...
// Sun Aug  6 08:58:27 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunI_Kaon_PosPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIPosPol_Kaon_h
#define PickyTrk_RunIPosPol_Kaon_h
...
class PickyTrk_RunIPosPol_Kaon {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[236];   //[nclus]
   Double_t        clusterttick[236];   //[nclus]
   Double_t        cluendwire[236];   //[nclus]
   Double_t        cluendtick[236];   //[nclus]
   Int_t           cluplane[236];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[35];   //[ntracks_reco]
   Double_t        trkvtxy[35];   //[ntracks_reco]
   Double_t        trkvtxz[35];   //[ntracks_reco]
   Double_t        trkendx[35];   //[ntracks_reco]
   Double_t        trkendy[35];   //[ntracks_reco]
   Double_t        trkendz[35];   //[ntracks_reco]
   Double_t        trkstartdcosx[35];   //[ntracks_reco]
   Double_t        trkstartdcosy[35];   //[ntracks_reco]
   Double_t        trkstartdcosz[35];   //[ntracks_reco]
   Double_t        trkenddcosx[35];   //[ntracks_reco]
   Double_t        trkenddcosy[35];   //[ntracks_reco]
   Double_t        trkenddcosz[35];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[35];   //[ntracks_reco]
   Double_t        trklength[35];   //[ntracks_reco]
   Double_t        trkmomrange[35];   //[ntracks_reco]
   Double_t        trkmommschi2[35];   //[ntracks_reco]
   Double_t        trkmommsllhd[35];   //[ntracks_reco]
   Int_t           ntrkhits[35];   //[ntracks_reco]
   Double_t        trkx[35][1000];   //[ntracks_reco]
   Double_t        trky[35][1000];   //[ntracks_reco]
   Double_t        trkz[35][1000];   //[ntracks_reco]
   Double_t        trkpitch[35][2];   //[ntracks_reco]
   Int_t           trkhits[35][2];   //[ntracks_reco]
   Double_t        trkdedx[35][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[35][2][1000];   //[ntracks_reco]
   Double_t        trkrr[35][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[35][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[35][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[35][2];   //[ntracks_reco]
   Double_t        trkpida[35][2];   //[ntracks_reco]
   Int_t           nTrajPoint[35];   //[ntracks_reco]
   Double_t        pHat0_X[35][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[35][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[35][1000];   //[ntracks_reco]
   Double_t        trjPt_X[35][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[35][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[35][1000];   //[ntracks_reco]
   Int_t           trkg4id[35];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[8930];   //[nhits]
   Int_t           hit_wire[8930];   //[nhits]
   Int_t           hit_channel[8930];   //[nhits]
   Double_t        hit_peakT[8930];   //[nhits]
   Double_t        hit_charge[8930];   //[nhits]
   Double_t        hit_ph[8930];   //[nhits]
   Double_t        hit_tstart[8930];   //[nhits]
   Double_t        hit_tend[8930];   //[nhits]
   Int_t           hit_trkid[8930];   //[nhits]
   Int_t           hit_trkkey[8930];   //[nhits]
   Int_t           hit_clukey[8930];   //[nhits]
   Int_t           hit_pk[8930];   //[nhits]
   Int_t           hit_t[8930];   //[nhits]
   Int_t           hit_ch[8930];   //[nhits]
   Int_t           hit_fwhh[8930];   //[nhits]
   Double_t        hit_rms[8930];   //[nhits]
   Double_t        hit_nelec[8930];   //[nhits]
   Double_t        hit_energy[8930];   //[nhits]
   Float_t         hit_dQds[8930];   //[nhits]
   Float_t         hit_dEds[8930];   //[nhits]
   Float_t         hit_ds[8930];   //[nhits]
   Float_t         hit_resrange[8930];   //[nhits]
   Float_t         hit_x[8930];   //[nhits]
   Float_t         hit_y[8930];   //[nhits]
   Float_t         hit_z[8930];   //[nhits]
   Int_t           nwctrks;
   ...
   PickyTrk_RunIPosPol_Kaon(TTree *tree=0);
   virtual ~PickyTrk_RunIPosPol_Kaon();
...
#ifdef PickyTrk_RunIPosPol_Kaon_cxx
PickyTrk_RunIPosPol_Kaon::PickyTrk_RunIPosPol_Kaon(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunI_Kaon_PosPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunI_Kaon_PosPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunI_Kaon_PosPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIPosPol_Kaon::~PickyTrk_RunIPosPol_Kaon()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIPosPol_Kaon::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIPosPol_Kaon::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIPosPol_Kaon::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIPosPol_Kaon::Notify()
{
...
void PickyTrk_RunIPosPol_Kaon::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIPosPol_Kaon::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIPosPol_Kaon_cxx

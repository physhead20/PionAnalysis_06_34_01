...
// Thu Aug  3 10:19:47 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunII_PiMuE_PosPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIIPosPol_PiMuE_h
#define PickyTrk_RunIIPosPol_PiMuE_h
...
class PickyTrk_RunIIPosPol_PiMuE {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[286];   //[nclus]
   Double_t        clusterttick[286];   //[nclus]
   Double_t        cluendwire[286];   //[nclus]
   Double_t        cluendtick[286];   //[nclus]
   Int_t           cluplane[286];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[53];   //[ntracks_reco]
   Double_t        trkvtxy[53];   //[ntracks_reco]
   Double_t        trkvtxz[53];   //[ntracks_reco]
   Double_t        trkendx[53];   //[ntracks_reco]
   Double_t        trkendy[53];   //[ntracks_reco]
   Double_t        trkendz[53];   //[ntracks_reco]
   Double_t        trkstartdcosx[53];   //[ntracks_reco]
   Double_t        trkstartdcosy[53];   //[ntracks_reco]
   Double_t        trkstartdcosz[53];   //[ntracks_reco]
   Double_t        trkenddcosx[53];   //[ntracks_reco]
   Double_t        trkenddcosy[53];   //[ntracks_reco]
   Double_t        trkenddcosz[53];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[53];   //[ntracks_reco]
   Double_t        trklength[53];   //[ntracks_reco]
   Double_t        trkmomrange[53];   //[ntracks_reco]
   Double_t        trkmommschi2[53];   //[ntracks_reco]
   Double_t        trkmommsllhd[53];   //[ntracks_reco]
   Int_t           ntrkhits[53];   //[ntracks_reco]
   Double_t        trkx[53][1000];   //[ntracks_reco]
   Double_t        trky[53][1000];   //[ntracks_reco]
   Double_t        trkz[53][1000];   //[ntracks_reco]
   Double_t        trkpitch[53][2];   //[ntracks_reco]
   Int_t           trkhits[53][2];   //[ntracks_reco]
   Double_t        trkdedx[53][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[53][2][1000];   //[ntracks_reco]
   Double_t        trkrr[53][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[53][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[53][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[53][2];   //[ntracks_reco]
   Double_t        trkpida[53][2];   //[ntracks_reco]
   Int_t           nTrajPoint[53];   //[ntracks_reco]
   Double_t        pHat0_X[53][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[53][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[53][1000];   //[ntracks_reco]
   Double_t        trjPt_X[53][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[53][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[53][1000];   //[ntracks_reco]
   Int_t           trkg4id[53];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[10632];   //[nhits]
   Int_t           hit_wire[10632];   //[nhits]
   Int_t           hit_channel[10632];   //[nhits]
   Double_t        hit_peakT[10632];   //[nhits]
   Double_t        hit_charge[10632];   //[nhits]
   Double_t        hit_ph[10632];   //[nhits]
   Double_t        hit_tstart[10632];   //[nhits]
   Double_t        hit_tend[10632];   //[nhits]
   Int_t           hit_trkid[10632];   //[nhits]
   Int_t           hit_trkkey[10632];   //[nhits]
   Int_t           hit_clukey[10632];   //[nhits]
   Int_t           hit_pk[10632];   //[nhits]
   Int_t           hit_t[10632];   //[nhits]
   Int_t           hit_ch[10632];   //[nhits]
   Int_t           hit_fwhh[10632];   //[nhits]
   Double_t        hit_rms[10632];   //[nhits]
   Double_t        hit_nelec[10632];   //[nhits]
   Double_t        hit_energy[10632];   //[nhits]
   Float_t         hit_dQds[10632];   //[nhits]
   Float_t         hit_dEds[10632];   //[nhits]
   Float_t         hit_ds[10632];   //[nhits]
   Float_t         hit_resrange[10632];   //[nhits]
   Float_t         hit_x[10632];   //[nhits]
   Float_t         hit_y[10632];   //[nhits]
   Float_t         hit_z[10632];   //[nhits]
   Int_t           nwctrks;
   ...
   PickyTrk_RunIIPosPol_PiMuE(TTree *tree=0);
   virtual ~PickyTrk_RunIIPosPol_PiMuE();
...
#ifdef PickyTrk_RunIIPosPol_PiMuE_cxx
PickyTrk_RunIIPosPol_PiMuE::PickyTrk_RunIIPosPol_PiMuE(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunII_PiMuE_PosPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunII_PiMuE_PosPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunII_PiMuE_PosPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIIPosPol_PiMuE::~PickyTrk_RunIIPosPol_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIIPosPol_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIIPosPol_PiMuE::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIIPosPol_PiMuE::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIIPosPol_PiMuE::Notify()
{
...
void PickyTrk_RunIIPosPol_PiMuE::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIIPosPol_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIIPosPol_PiMuE_cxx

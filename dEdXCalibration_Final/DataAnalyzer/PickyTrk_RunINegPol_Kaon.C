#define PickyTrk_RunINegPol_Kaon_cxx
#include "PickyTrk_RunINegPol_Kaon.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PickyTrk_RunINegPol_Kaon::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunINeg_Picky_Kaon_Collection.root","RECREATE");
//TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunINeg_Picky_Kaon_Induction.root","RECREATE");

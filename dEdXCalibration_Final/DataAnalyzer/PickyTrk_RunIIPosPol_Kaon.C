#define PickyTrk_RunIIPosPol_Kaon_cxx
#include "PickyTrk_RunIIPosPol_Kaon.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void PickyTrk_RunIIPosPol_Kaon::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIIPos_Picky_Kaon_Collection.root","RECREATE");
//TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIIPos_Picky_Kaon_Induction.root","RECREATE");

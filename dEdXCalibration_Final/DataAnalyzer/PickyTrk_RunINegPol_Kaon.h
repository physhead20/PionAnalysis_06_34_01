...
// Sun Aug  6 10:27:44 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunI_Kaon_NegPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunINegPol_Kaon_h
#define PickyTrk_RunINegPol_Kaon_h
...
class PickyTrk_RunINegPol_Kaon {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[281];   //[nclus]
   Double_t        clusterttick[281];   //[nclus]
   Double_t        cluendwire[281];   //[nclus]
   Double_t        cluendtick[281];   //[nclus]
   Int_t           cluplane[281];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[36];   //[ntracks_reco]
   Double_t        trkvtxy[36];   //[ntracks_reco]
   Double_t        trkvtxz[36];   //[ntracks_reco]
   Double_t        trkendx[36];   //[ntracks_reco]
   Double_t        trkendy[36];   //[ntracks_reco]
   Double_t        trkendz[36];   //[ntracks_reco]
   Double_t        trkstartdcosx[36];   //[ntracks_reco]
   Double_t        trkstartdcosy[36];   //[ntracks_reco]
   Double_t        trkstartdcosz[36];   //[ntracks_reco]
   Double_t        trkenddcosx[36];   //[ntracks_reco]
   Double_t        trkenddcosy[36];   //[ntracks_reco]
   Double_t        trkenddcosz[36];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[36];   //[ntracks_reco]
   Double_t        trklength[36];   //[ntracks_reco]
   Double_t        trkmomrange[36];   //[ntracks_reco]
   Double_t        trkmommschi2[36];   //[ntracks_reco]
   Double_t        trkmommsllhd[36];   //[ntracks_reco]
   Int_t           ntrkhits[36];   //[ntracks_reco]
   Double_t        trkx[36][1000];   //[ntracks_reco]
   Double_t        trky[36][1000];   //[ntracks_reco]
   Double_t        trkz[36][1000];   //[ntracks_reco]
   Double_t        trkpitch[36][2];   //[ntracks_reco]
   Int_t           trkhits[36][2];   //[ntracks_reco]
   Double_t        trkdedx[36][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[36][2][1000];   //[ntracks_reco]
   Double_t        trkrr[36][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[36][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[36][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[36][2];   //[ntracks_reco]
   Double_t        trkpida[36][2];   //[ntracks_reco]
   Int_t           nTrajPoint[36];   //[ntracks_reco]
   Double_t        pHat0_X[36][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[36][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[36][1000];   //[ntracks_reco]
   Double_t        trjPt_X[36][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[36][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[36][1000];   //[ntracks_reco]
   Int_t           trkg4id[36];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[12375];   //[nhits]
   Int_t           hit_wire[12375];   //[nhits]
   Int_t           hit_channel[12375];   //[nhits]
   Double_t        hit_peakT[12375];   //[nhits]
   Double_t        hit_charge[12375];   //[nhits]
   Double_t        hit_ph[12375];   //[nhits]
   Double_t        hit_tstart[12375];   //[nhits]
   Double_t        hit_tend[12375];   //[nhits]
   Int_t           hit_trkid[12375];   //[nhits]
   Int_t           hit_trkkey[12375];   //[nhits]
   Int_t           hit_clukey[12375];   //[nhits]
   Int_t           hit_pk[12375];   //[nhits]
   Int_t           hit_t[12375];   //[nhits]
   Int_t           hit_ch[12375];   //[nhits]
   Int_t           hit_fwhh[12375];   //[nhits]
   Double_t        hit_rms[12375];   //[nhits]
   Double_t        hit_nelec[12375];   //[nhits]
   Double_t        hit_energy[12375];   //[nhits]
   Float_t         hit_dQds[12375];   //[nhits]
   Float_t         hit_dEds[12375];   //[nhits]
   Float_t         hit_ds[12375];   //[nhits]
   Float_t         hit_resrange[12375];   //[nhits]
   Float_t         hit_x[12375];   //[nhits]
   Float_t         hit_y[12375];   //[nhits]
   Float_t         hit_z[12375];   //[nhits]
   Int_t           nwctrks;
   ...
   PickyTrk_RunINegPol_Kaon(TTree *tree=0);
   virtual ~PickyTrk_RunINegPol_Kaon();
...
#ifdef PickyTrk_RunINegPol_Kaon_cxx
PickyTrk_RunINegPol_Kaon::PickyTrk_RunINegPol_Kaon(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunI_Kaon_NegPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunI_Kaon_NegPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunI_Kaon_NegPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunINegPol_Kaon::~PickyTrk_RunINegPol_Kaon()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunINegPol_Kaon::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunINegPol_Kaon::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunINegPol_Kaon::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunINegPol_Kaon::Notify()
{
...
void PickyTrk_RunINegPol_Kaon::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunINegPol_Kaon::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunINegPol_Kaon_cxx

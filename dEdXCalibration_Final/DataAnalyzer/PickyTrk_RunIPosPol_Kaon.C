#define PickyTrk_RunIPosPol_Kaon_cxx
#include "PickyTrk_RunIPosPol_Kaon.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PickyTrk_RunIPosPol_Kaon::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIPos_Picky_Kaon_Collection.root","RECREATE");
//TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunIPos_Picky_Kaon_Induction.root","RECREATE");

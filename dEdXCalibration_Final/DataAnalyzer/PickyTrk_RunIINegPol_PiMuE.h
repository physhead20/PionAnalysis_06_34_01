...
// Sun Aug  6 09:17:03 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunII_PiMuE_NegPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIINegPol_PiMuE_h
#define PickyTrk_RunIINegPol_PiMuE_h
...
class PickyTrk_RunIINegPol_PiMuE {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[442];   //[nclus]
   Double_t        clusterttick[442];   //[nclus]
   Double_t        cluendwire[442];   //[nclus]
   Double_t        cluendtick[442];   //[nclus]
   Int_t           cluplane[442];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[90];   //[ntracks_reco]
   Double_t        trkvtxy[90];   //[ntracks_reco]
   Double_t        trkvtxz[90];   //[ntracks_reco]
   Double_t        trkendx[90];   //[ntracks_reco]
   Double_t        trkendy[90];   //[ntracks_reco]
   Double_t        trkendz[90];   //[ntracks_reco]
   Double_t        trkstartdcosx[90];   //[ntracks_reco]
   Double_t        trkstartdcosy[90];   //[ntracks_reco]
   Double_t        trkstartdcosz[90];   //[ntracks_reco]
   Double_t        trkenddcosx[90];   //[ntracks_reco]
   Double_t        trkenddcosy[90];   //[ntracks_reco]
   Double_t        trkenddcosz[90];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[90];   //[ntracks_reco]
   Double_t        trklength[90];   //[ntracks_reco]
   Double_t        trkmomrange[90];   //[ntracks_reco]
   Double_t        trkmommschi2[90];   //[ntracks_reco]
   Double_t        trkmommsllhd[90];   //[ntracks_reco]
   Int_t           ntrkhits[90];   //[ntracks_reco]
   Double_t        trkx[90][1000];   //[ntracks_reco]
   Double_t        trky[90][1000];   //[ntracks_reco]
   Double_t        trkz[90][1000];   //[ntracks_reco]
   Double_t        trkpitch[90][2];   //[ntracks_reco]
   Int_t           trkhits[90][2];   //[ntracks_reco]
   Double_t        trkdedx[90][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[90][2][1000];   //[ntracks_reco]
   Double_t        trkrr[90][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[90][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[90][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[90][2];   //[ntracks_reco]
   Double_t        trkpida[90][2];   //[ntracks_reco]
   Int_t           nTrajPoint[90];   //[ntracks_reco]
   Double_t        pHat0_X[90][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[90][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[90][1000];   //[ntracks_reco]
   Double_t        trjPt_X[90][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[90][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[90][1000];   //[ntracks_reco]
   Int_t           trkg4id[90];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[14720];   //[nhits]
   Int_t           hit_wire[14720];   //[nhits]
   Int_t           hit_channel[14720];   //[nhits]
   Double_t        hit_peakT[14720];   //[nhits]
   Double_t        hit_charge[14720];   //[nhits]
   Double_t        hit_ph[14720];   //[nhits]
   Double_t        hit_tstart[14720];   //[nhits]
   Double_t        hit_tend[14720];   //[nhits]
   Int_t           hit_trkid[14720];   //[nhits]
   Int_t           hit_trkkey[14720];   //[nhits]
   Int_t           hit_clukey[14720];   //[nhits]
   Int_t           hit_pk[14720];   //[nhits]
   Int_t           hit_t[14720];   //[nhits]
   Int_t           hit_ch[14720];   //[nhits]
   Int_t           hit_fwhh[14720];   //[nhits]
   Double_t        hit_rms[14720];   //[nhits]
   Double_t        hit_nelec[14720];   //[nhits]
   Double_t        hit_energy[14720];   //[nhits]
   Float_t         hit_dQds[14720];   //[nhits]
   Float_t         hit_dEds[14720];   //[nhits]
   Float_t         hit_ds[14720];   //[nhits]
   Float_t         hit_resrange[14720];   //[nhits]
   Float_t         hit_x[14720];   //[nhits]
   Float_t         hit_y[14720];   //[nhits]
   Float_t         hit_z[14720];   //[nhits]
   Int_t           nwctrks;
   ...
   PickyTrk_RunIINegPol_PiMuE(TTree *tree=0);
   virtual ~PickyTrk_RunIINegPol_PiMuE();
...
#ifdef PickyTrk_RunIINegPol_PiMuE_cxx
PickyTrk_RunIINegPol_PiMuE::PickyTrk_RunIINegPol_PiMuE(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunII_PiMuE_NegPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunII_PiMuE_NegPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunII_PiMuE_NegPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIINegPol_PiMuE::~PickyTrk_RunIINegPol_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIINegPol_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIINegPol_PiMuE::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIINegPol_PiMuE::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIINegPol_PiMuE::Notify()
{
...
void PickyTrk_RunIINegPol_PiMuE::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIINegPol_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIINegPol_PiMuE_cxx

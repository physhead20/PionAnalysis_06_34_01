...
// Thu Aug  3 14:36:36 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunI_PiMuE_PosPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIPosPol_PiMuE_h
#define PickyTrk_RunIPosPol_PiMuE_h
...
class PickyTrk_RunIPosPol_PiMuE {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[354];   //[nclus]
   Double_t        clusterttick[354];   //[nclus]
   Double_t        cluendwire[354];   //[nclus]
   Double_t        cluendtick[354];   //[nclus]
   Int_t           cluplane[354];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[61];   //[ntracks_reco]
   Double_t        trkvtxy[61];   //[ntracks_reco]
   Double_t        trkvtxz[61];   //[ntracks_reco]
   Double_t        trkendx[61];   //[ntracks_reco]
   Double_t        trkendy[61];   //[ntracks_reco]
   Double_t        trkendz[61];   //[ntracks_reco]
   Double_t        trkstartdcosx[61];   //[ntracks_reco]
   Double_t        trkstartdcosy[61];   //[ntracks_reco]
   Double_t        trkstartdcosz[61];   //[ntracks_reco]
   Double_t        trkenddcosx[61];   //[ntracks_reco]
   Double_t        trkenddcosy[61];   //[ntracks_reco]
   Double_t        trkenddcosz[61];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[61];   //[ntracks_reco]
   Double_t        trklength[61];   //[ntracks_reco]
   Double_t        trkmomrange[61];   //[ntracks_reco]
   Double_t        trkmommschi2[61];   //[ntracks_reco]
   Double_t        trkmommsllhd[61];   //[ntracks_reco]
   Int_t           ntrkhits[61];   //[ntracks_reco]
   Double_t        trkx[61][1000];   //[ntracks_reco]
   Double_t        trky[61][1000];   //[ntracks_reco]
   Double_t        trkz[61][1000];   //[ntracks_reco]
   Double_t        trkpitch[61][2];   //[ntracks_reco]
   Int_t           trkhits[61][2];   //[ntracks_reco]
   Double_t        trkdedx[61][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[61][2][1000];   //[ntracks_reco]
   Double_t        trkrr[61][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[61][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[61][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[61][2];   //[ntracks_reco]
   Double_t        trkpida[61][2];   //[ntracks_reco]
   Int_t           nTrajPoint[61];   //[ntracks_reco]
   Double_t        pHat0_X[61][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[61][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[61][1000];   //[ntracks_reco]
   Double_t        trjPt_X[61][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[61][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[61][1000];   //[ntracks_reco]
   Int_t           trkg4id[61];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[12663];   //[nhits]
   Int_t           hit_wire[12663];   //[nhits]
   Int_t           hit_channel[12663];   //[nhits]
   Double_t        hit_peakT[12663];   //[nhits]
   Double_t        hit_charge[12663];   //[nhits]
   Double_t        hit_ph[12663];   //[nhits]
   Double_t        hit_tstart[12663];   //[nhits]
   Double_t        hit_tend[12663];   //[nhits]
   Int_t           hit_trkid[12663];   //[nhits]
   Int_t           hit_trkkey[12663];   //[nhits]
   Int_t           hit_clukey[12663];   //[nhits]
   Int_t           hit_pk[12663];   //[nhits]
   Int_t           hit_t[12663];   //[nhits]
   Int_t           hit_ch[12663];   //[nhits]
   Int_t           hit_fwhh[12663];   //[nhits]
   Double_t        hit_rms[12663];   //[nhits]
   Double_t        hit_nelec[12663];   //[nhits]
   Double_t        hit_energy[12663];   //[nhits]
   Float_t         hit_dQds[12663];   //[nhits]
   Float_t         hit_dEds[12663];   //[nhits]
   Float_t         hit_ds[12663];   //[nhits]
   Float_t         hit_resrange[12663];   //[nhits]
   Float_t         hit_x[12663];   //[nhits]
   Float_t         hit_y[12663];   //[nhits]
   Float_t         hit_z[12663];   //[nhits]
   Int_t           nwctrks;
   ...
   PickyTrk_RunIPosPol_PiMuE(TTree *tree=0);
   virtual ~PickyTrk_RunIPosPol_PiMuE();
...
#ifdef PickyTrk_RunIPosPol_PiMuE_cxx
PickyTrk_RunIPosPol_PiMuE::PickyTrk_RunIPosPol_PiMuE(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunI_PiMuE_PosPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunI_PiMuE_PosPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunI_PiMuE_PosPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIPosPol_PiMuE::~PickyTrk_RunIPosPol_PiMuE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIPosPol_PiMuE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIPosPol_PiMuE::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIPosPol_PiMuE::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIPosPol_PiMuE::Notify()
{
...
void PickyTrk_RunIPosPol_PiMuE::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIPosPol_PiMuE::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIPosPol_PiMuE_cxx

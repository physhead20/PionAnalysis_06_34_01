...
// Thu Aug  3 13:46:55 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../../ROOTFILES/PickyTrack_RunII_Proton_PosPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIIPosPol_Proton_h
#define PickyTrk_RunIIPosPol_Proton_h
...
class PickyTrk_RunIIPosPol_Proton {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[311];   //[nclus]
   Double_t        clusterttick[311];   //[nclus]
   Double_t        cluendwire[311];   //[nclus]
   Double_t        cluendtick[311];   //[nclus]
   Int_t           cluplane[311];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[65];   //[ntracks_reco]
   Double_t        trkvtxy[65];   //[ntracks_reco]
   Double_t        trkvtxz[65];   //[ntracks_reco]
   Double_t        trkendx[65];   //[ntracks_reco]
   Double_t        trkendy[65];   //[ntracks_reco]
   Double_t        trkendz[65];   //[ntracks_reco]
   Double_t        trkstartdcosx[65];   //[ntracks_reco]
   Double_t        trkstartdcosy[65];   //[ntracks_reco]
   Double_t        trkstartdcosz[65];   //[ntracks_reco]
   Double_t        trkenddcosx[65];   //[ntracks_reco]
   Double_t        trkenddcosy[65];   //[ntracks_reco]
   Double_t        trkenddcosz[65];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[65];   //[ntracks_reco]
   Double_t        trklength[65];   //[ntracks_reco]
   Double_t        trkmomrange[65];   //[ntracks_reco]
   Double_t        trkmommschi2[65];   //[ntracks_reco]
   Double_t        trkmommsllhd[65];   //[ntracks_reco]
   Int_t           ntrkhits[65];   //[ntracks_reco]
   Double_t        trkx[65][1000];   //[ntracks_reco]
   Double_t        trky[65][1000];   //[ntracks_reco]
   Double_t        trkz[65][1000];   //[ntracks_reco]
   Double_t        trkpitch[65][2];   //[ntracks_reco]
   Int_t           trkhits[65][2];   //[ntracks_reco]
   Double_t        trkdedx[65][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[65][2][1000];   //[ntracks_reco]
   Double_t        trkrr[65][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[65][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[65][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[65][2];   //[ntracks_reco]
   Double_t        trkpida[65][2];   //[ntracks_reco]
   Int_t           nTrajPoint[65];   //[ntracks_reco]
   Double_t        pHat0_X[65][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[65][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[65][1000];   //[ntracks_reco]
   Double_t        trjPt_X[65][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[65][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[65][1000];   //[ntracks_reco]
   Int_t           trkg4id[65];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[11944];   //[nhits]
   Int_t           hit_wire[11944];   //[nhits]
   Int_t           hit_channel[11944];   //[nhits]
   Double_t        hit_peakT[11944];   //[nhits]
   Double_t        hit_charge[11944];   //[nhits]
   Double_t        hit_ph[11944];   //[nhits]
   Double_t        hit_tstart[11944];   //[nhits]
   Double_t        hit_tend[11944];   //[nhits]
   Int_t           hit_trkid[11944];   //[nhits]
   Int_t           hit_trkkey[11944];   //[nhits]
   Int_t           hit_clukey[11944];   //[nhits]
   Int_t           hit_pk[11944];   //[nhits]
   Int_t           hit_t[11944];   //[nhits]
   Int_t           hit_ch[11944];   //[nhits]
   Int_t           hit_fwhh[11944];   //[nhits]
   Double_t        hit_rms[11944];   //[nhits]
   Double_t        hit_nelec[11944];   //[nhits]
   Double_t        hit_energy[11944];   //[nhits]
   Float_t         hit_dQds[11944];   //[nhits]
   Float_t         hit_dEds[11944];   //[nhits]
   Float_t         hit_ds[11944];   //[nhits]
   Float_t         hit_resrange[11944];   //[nhits]
   Float_t         hit_x[11944];   //[nhits]
   Float_t         hit_y[11944];   //[nhits]
   Float_t         hit_z[11944];   //[nhits]
   Int_t           nwctrks;
   ...
   PickyTrk_RunIIPosPol_Proton(TTree *tree=0);
   virtual ~PickyTrk_RunIIPosPol_Proton();
...
#ifdef PickyTrk_RunIIPosPol_Proton_cxx
PickyTrk_RunIIPosPol_Proton::PickyTrk_RunIIPosPol_Proton(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../ROOTFILES/PickyTrack_RunII_Proton_PosPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../ROOTFILES/PickyTrack_RunII_Proton_PosPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../ROOTFILES/PickyTrack_RunII_Proton_PosPol_Reco_v06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIIPosPol_Proton::~PickyTrk_RunIIPosPol_Proton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIIPosPol_Proton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIIPosPol_Proton::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIIPosPol_Proton::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIIPosPol_Proton::Notify()
{
...
void PickyTrk_RunIIPosPol_Proton::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIIPosPol_Proton::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIIPosPol_Proton_cxx

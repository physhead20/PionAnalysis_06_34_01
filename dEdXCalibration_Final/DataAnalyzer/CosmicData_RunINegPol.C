#define CosmicData_RunINegPol_cxx
#include "CosmicData_RunINegPol.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void CosmicData_RunINegPol::Loop()
{
if (fChain == 0) return;
...
// ###			Name your ROOT file		  ###
// ##########################################################
TFile myfile("../../histoROOTfiles_forPlots/CosmicData_RunINegPol_Collection.root","RECREATE"); 

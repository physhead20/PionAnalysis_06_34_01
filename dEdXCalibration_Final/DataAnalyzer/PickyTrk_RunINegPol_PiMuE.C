#define PickyTrk_RunINegPol_PiMuE_cxx
#include "PickyTrk_RunINegPol_PiMuE.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PickyTrk_RunINegPol_PiMuE::Loop()
{
if (fChain == 0) return;
...
TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunINeg_Picky_PiMuE_Collection.root","RECREATE");
//TFile myfile("../../histoROOTfiles_forPlots/dEdXCalib_RunINeg_Picky_PiMuE_Induction.root","RECREATE");

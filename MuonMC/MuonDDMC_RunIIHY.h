...
// Thu Aug 24 08:11:48 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/DDMC_RunIINegHYMuon_anatree.root
//////////////////////////////////////////////////////////

#ifndef MuonDDMC_RunIIHY_h
#define MuonDDMC_RunIIHY_h
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[41];   //[nclus]
   Double_t        clusterttick[41];   //[nclus]
   Double_t        cluendwire[41];   //[nclus]
   Double_t        cluendtick[41];   //[nclus]
   Int_t           cluplane[41];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[576];   //[nhits]
   Int_t           hit_wire[576];   //[nhits]
   Int_t           hit_channel[576];   //[nhits]
   Double_t        hit_peakT[576];   //[nhits]
   Double_t        hit_charge[576];   //[nhits]
   Double_t        hit_ph[576];   //[nhits]
   Double_t        hit_tstart[576];   //[nhits]
   Double_t        hit_tend[576];   //[nhits]
   Int_t           hit_trkid[576];   //[nhits]
   Int_t           hit_trkkey[576];   //[nhits]
   Int_t           hit_clukey[576];   //[nhits]
   Int_t           hit_pk[576];   //[nhits]
   Int_t           hit_t[576];   //[nhits]
   Int_t           hit_ch[576];   //[nhits]
   Int_t           hit_fwhh[576];   //[nhits]
   Double_t        hit_rms[576];   //[nhits]
   Double_t        hit_nelec[576];   //[nhits]
   Double_t        hit_energy[576];   //[nhits]
   Float_t         hit_dQds[576];   //[nhits]
   Float_t         hit_dEds[576];   //[nhits]
   Float_t         hit_ds[576];   //[nhits]
   Float_t         hit_resrange[576];   //[nhits]
   Float_t         hit_x[576];   //[nhits]
   Float_t         hit_y[576];   //[nhits]
   Float_t         hit_z[576];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[3226];   //[maxTrackIDE]
   Double_t        IDEPos[3226][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[72];   //[geant_list_size]
   Double_t        Eng[72];   //[geant_list_size]
   Double_t        Px[72];   //[geant_list_size]
   Double_t        Py[72];   //[geant_list_size]
   Double_t        Pz[72];   //[geant_list_size]
   Double_t        EndEng[72];   //[geant_list_size]
   Double_t        EndPx[72];   //[geant_list_size]
   Double_t        EndPy[72];   //[geant_list_size]
   Double_t        EndPz[72];   //[geant_list_size]
   Double_t        StartPointx[72];   //[geant_list_size]
   Double_t        StartPointy[72];   //[geant_list_size]
   Double_t        StartPointz[72];   //[geant_list_size]
   Double_t        EndPointx[72];   //[geant_list_size]
   Double_t        EndPointy[72];   //[geant_list_size]
   Double_t        EndPointz[72];   //[geant_list_size]
   Int_t           Process[72];   //[geant_list_size]
   Int_t           NumberDaughters[72];   //[geant_list_size]
   Int_t           Mother[72];   //[geant_list_size]
   Int_t           TrackId[72];   //[geant_list_size]
   Int_t           process_primary[72];   //[geant_list_size]
   ...
   MuonDDMC_RunIIHY(TTree *tree=0);
   virtual ~MuonDDMC_RunIIHY();
...
#ifdef MuonDDMC_RunIIHY_cxx
MuonDDMC_RunIIHY::MuonDDMC_RunIIHY(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/DDMC_RunIINegHYMuon_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/DDMC_RunIINegHYMuon_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/DDMC_RunIINegHYMuon_anatree.root:/anatree");
...
MuonDDMC_RunIIHY::~MuonDDMC_RunIIHY()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MuonDDMC_RunIIHY::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MuonDDMC_RunIIHY::LoadTree(Long64_t entry)
{
...
void MuonDDMC_RunIIHY::Init(TTree *tree)
{
...
Bool_t MuonDDMC_RunIIHY::Notify()
{
...
void MuonDDMC_RunIIHY::Show(Long64_t entry)
{
...
Int_t MuonDDMC_RunIIHY::Cut(Long64_t entry)
{
...
#endif // #ifdef MuonDDMC_RunIIHY_cxx

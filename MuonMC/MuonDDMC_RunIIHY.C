#define MuonDDMC_RunIIHY_cxx
#include "MuonDDMC_RunIIHY.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
TFile myfile("../histoROOTfiles_forPlots/DDMC_Muon_RunIIHY_histo.root","RECREATE");

...
// Thu Aug 24 09:40:34 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/MC_PhotonFlatDist_anatree.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[117];   //[nclus]
   Double_t        clusterttick[117];   //[nclus]
   Double_t        cluendwire[117];   //[nclus]
   Double_t        cluendtick[117];   //[nclus]
   Int_t           cluplane[117];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[37];   //[ntracks_reco]
   Double_t        trkvtxy[37];   //[ntracks_reco]
   Double_t        trkvtxz[37];   //[ntracks_reco]
   Double_t        trkendx[37];   //[ntracks_reco]
   Double_t        trkendy[37];   //[ntracks_reco]
   Double_t        trkendz[37];   //[ntracks_reco]
   Double_t        trkstartdcosx[37];   //[ntracks_reco]
   Double_t        trkstartdcosy[37];   //[ntracks_reco]
   Double_t        trkstartdcosz[37];   //[ntracks_reco]
   Double_t        trkenddcosx[37];   //[ntracks_reco]
   Double_t        trkenddcosy[37];   //[ntracks_reco]
   Double_t        trkenddcosz[37];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[37];   //[ntracks_reco]
   Double_t        trklength[37];   //[ntracks_reco]
   Double_t        trkmomrange[37];   //[ntracks_reco]
   Double_t        trkmommschi2[37];   //[ntracks_reco]
   Double_t        trkmommsllhd[37];   //[ntracks_reco]
   Int_t           ntrkhits[37];   //[ntracks_reco]
   Double_t        trkx[37][1000];   //[ntracks_reco]
   Double_t        trky[37][1000];   //[ntracks_reco]
   Double_t        trkz[37][1000];   //[ntracks_reco]
   Double_t        trkpitch[37][2];   //[ntracks_reco]
   Int_t           trkhits[37][2];   //[ntracks_reco]
   Double_t        trkdedx[37][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[37][2][1000];   //[ntracks_reco]
   Double_t        trkrr[37][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[37][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[37][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[37][2];   //[ntracks_reco]
   Double_t        trkpida[37][2];   //[ntracks_reco]
   Int_t           nTrajPoint[37];   //[ntracks_reco]
   Double_t        pHat0_X[37][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[37][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[37][1000];   //[ntracks_reco]
   Double_t        trjPt_X[37][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[37][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[37][1000];   //[ntracks_reco]
   Int_t           trkg4id[37];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1750];   //[nhits]
   Int_t           hit_wire[1750];   //[nhits]
   Int_t           hit_channel[1750];   //[nhits]
   Double_t        hit_peakT[1750];   //[nhits]
   Double_t        hit_charge[1750];   //[nhits]
   Double_t        hit_ph[1750];   //[nhits]
   Double_t        hit_tstart[1750];   //[nhits]
   Double_t        hit_tend[1750];   //[nhits]
   Int_t           hit_trkid[1750];   //[nhits]
   Int_t           hit_trkkey[1750];   //[nhits]
   Int_t           hit_clukey[1750];   //[nhits]
   Int_t           hit_pk[1750];   //[nhits]
   Int_t           hit_t[1750];   //[nhits]
   Int_t           hit_ch[1750];   //[nhits]
   Int_t           hit_fwhh[1750];   //[nhits]
   Double_t        hit_rms[1750];   //[nhits]
   Double_t        hit_nelec[1750];   //[nhits]
   Double_t        hit_energy[1750];   //[nhits]
   Float_t         hit_dQds[1750];   //[nhits]
   Float_t         hit_dEds[1750];   //[nhits]
   Float_t         hit_ds[1750];   //[nhits]
   Float_t         hit_resrange[1750];   //[nhits]
   Float_t         hit_x[1750];   //[nhits]
   Float_t         hit_y[1750];   //[nhits]
   Float_t         hit_z[1750];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           pdg[247];   //[geant_list_size]
   Double_t        Eng[247];   //[geant_list_size]
   Double_t        Px[247];   //[geant_list_size]
   Double_t        Py[247];   //[geant_list_size]
   Double_t        Pz[247];   //[geant_list_size]
   Double_t        EndEng[247];   //[geant_list_size]
   Double_t        EndPx[247];   //[geant_list_size]
   Double_t        EndPy[247];   //[geant_list_size]
   Double_t        EndPz[247];   //[geant_list_size]
   Double_t        StartPointx[247];   //[geant_list_size]
   Double_t        StartPointy[247];   //[geant_list_size]
   Double_t        StartPointz[247];   //[geant_list_size]
   Double_t        EndPointx[247];   //[geant_list_size]
   Double_t        EndPointy[247];   //[geant_list_size]
   Double_t        EndPointz[247];   //[geant_list_size]
   Int_t           Process[247];   //[geant_list_size]
   Int_t           NumberDaughters[247];   //[geant_list_size]
   Int_t           Mother[247];   //[geant_list_size]
   Int_t           TrackId[247];   //[geant_list_size]
   Int_t           process_primary[247];   //[geant_list_size]
...
#ifdef PhotonMC_cxx
PhotonMC::PhotonMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/MC_PhotonFlatDist_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/MC_PhotonFlatDist_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/MC_PhotonFlatDist_anatree.root:/anatree");
...
Int_t PhotonMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PhotonMC::LoadTree(Long64_t entry)
{
...
void PhotonMC::Show(Long64_t entry)
{
...
Int_t PhotonMC::Cut(Long64_t entry)
{

...
// ### Load Data Plots      ###
// ############################
TFile *f1 = new TFile("../histoROOTfiles_forPlots/RunINeg_Picky_PiMuE_dataHisto.root");

// ##############################################
// ### Load the histograms from the data file ###
// ##############################################
...
// ===============================================================
// === Scale the incident histogram for the muon contamination ===
// ===============================================================    
hDataInc->Scale(MuonContaminationScaleFactor);

// === Get the number of bins for the incident histogram ===
...
// ### We start at bin 3 since the first two bins are below 0 MeV ###
// ###                                                            ###
// ### Starting at bin 1 will include the negative energy bins    ###
// ##################################################################
...
MCCrossSys->SetName("MCCrossSys");
 ...
 for (int i = startBin; i <= nbinsMC; i++ ) {
...
c01->Print("./images/RunINegPol_xsec_MCband_opt1.png");
...
c02->cd();
 ...
 c02->Print("./images/RunINegPol_xsec_MCband_opt2.png");
...
c03->cd();
 ...
 c03->Print("./images/RunINegPol_xsec_MC_noband.png");

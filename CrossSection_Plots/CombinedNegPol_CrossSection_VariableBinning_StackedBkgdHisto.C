...
float VariableCrossSection[42] = {0.};
float VariableCrossSectionError[42] = {0.};
...
// ################################################################
for(int i = 3; i <= hDataInc->GetNbinsX(); i++)
   {
   ...
   std::cout<<"i = "<<i-3<<", "<<(i-3)*50<<" cross-section = "<<TempCrossSection<<" +/-"<<datasigbinom<<std::endl;
...
// ####################################################
const Int_t MCnBins = 20;
Double_t MCedges[MCnBins+1] = {0, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 900, 1200, 1500, 1800};

TH1* hVariableBinCrossSectionMC = new TH1D("hVariableBinCrossSectionMC", "Cross-Section", MCnBins, MCedges);

float VariableCrossSectionMC[42] = {0.};
float VariableCrossSectionErrorMC[42] = {0.};
...
float VariableCrossSectionMCSys[42] = {0.};
float VariableCrossSectionErrorMCSys[42] = {0.};
...
//   MCCrossSection->SetBinError(i,MCsigbinom);
   ...
   std::cout <<"i = "<<i-3<<", "<<(i-3)*50<<", "<< crossSection << " +/- " << MCstat*crossSection << "(stat) +/- " << MCsysstat << std::endl;
...
float bin19 = (VariableCrossSectionMCSys[24] + VariableCrossSectionMCSys[25] + VariableCrossSectionMCSys[26] + VariableCrossSectionMCSys[27] + VariableCrossSectionMCSys[28] + VariableCrossSectionMCSys[29]) / 6;
...
float bin20 = (VariableCrossSectionMCSys[30] + VariableCrossSectionMCSys[31] + VariableCrossSectionMCSys[32] + VariableCrossSectionMCSys[33] + VariableCrossSectionMCSys[34] + VariableCrossSectionMCSys[35]) / 6;
hVariableBinCrossSectionMCSys->SetBinContent(20,bin20);
float bin20error = (sqrt( pow(VariableCrossSectionErrorMCSys[30],2) + pow(VariableCrossSectionErrorMCSys[31],2) + pow(VariableCrossSectionErrorMCSys[32],2)+
                          pow(VariableCrossSectionErrorMCSys[33],2) + pow(VariableCrossSectionErrorMCSys[34],2) + pow(VariableCrossSectionErrorMCSys[35],2)) );
hVariableBinCrossSectionMCSys->SetBinError(20,bin20error);
...
float bin19 = (VariableCrossSectionMC[24] + VariableCrossSectionMC[25] + VariableCrossSectionMC[26] + VariableCrossSectionMC[27] + VariableCrossSectionMC[28] + VariableCrossSectionMC[29]) / 6;
...
float bin20 = (VariableCrossSectionMC[30] + VariableCrossSectionMC[31] + VariableCrossSectionMC[32] + VariableCrossSectionMC[33] + VariableCrossSectionMC[34] + VariableCrossSectionMC[35]) / 6;
hVariableBinCrossSectionMC->SetBinContent(20,bin20);
float bin20error = (sqrt( pow(VariableCrossSectionErrorMC[30],2) + pow(VariableCrossSectionErrorMC[31],2) + pow(VariableCrossSectionErrorMC[32],2)+
                          pow(VariableCrossSectionErrorMC[33],2) + pow(VariableCrossSectionErrorMC[34],2) + pow(VariableCrossSectionErrorMC[35],2) ) );
hVariableBinCrossSectionMC->SetBinError(20,bin20error);
// --------------------------------------------------------------------------------------------------------------------------
